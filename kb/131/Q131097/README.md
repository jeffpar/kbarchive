...
{% raw %}
	...
	The following two versions of Microsoft Mail for the Macintosh are available:
	...
	When you send a file attachments from a Macintosh client, you can choose the
