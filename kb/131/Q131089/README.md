...
{% raw %}
	...
	If you resize the Planner window after you select a multi-day section, the
	selected section will truncate to include only those times that will fit inside
	the resized box.
	...
	Additional query words: schedule plus 7.00 highlighted
