...
## Q113916: Copy from One Novell Server to Another Fails
	...
	When you copy a file from one Novell file server to another using Gateway
	Services for NetWare, the copy operation fails. During the copy, other computers
	connected to the Novell file servers may halt until the copy operation fails.
