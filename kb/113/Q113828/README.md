...
{% raw %}
	...
	Creative Labs Sound Blaster 16 does not play CD audio (music) when you run Music
	...
	The default setting for the CD audio option is off after the initial setup of
