...
{% raw %}
	...
	When a sticker in Fine Artist is resized using the Shrinker and then enlarged
	...
	When a sticker is reduced in size, pixels are removed to scale down the bitmap.
