...
{% raw %}
	...
	After turning on strong encryption by running Syskey.exe, Windows NT Server,
	Terminal Server Edition clients experience intermittent problems displaying the
	logon screen.
