...
{% raw %}
	...
	You may find that the screen paging does not keep up with the music when you
	...
	To avoid this problem, maximize available memory and system resources by closing
