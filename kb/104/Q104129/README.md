...
{% raw %}
	...
	The Subject field of a Microsoft Schedule+ for Windows message destined for an
	X.400 loop-around user is not correct. An X.400 loop-around user is one where
	the message returns to the user through the X.400 gateway.
