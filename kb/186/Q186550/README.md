...
## Q186550: Terminal Server Error Messages: 1000 to 1199
	...
	This article describes Terminal Server error messages 1000 to 1199.
	...
	----------
	  ...
	  corrupt, or the file could not be recovered because the alternate copy or log
	  was absent or corrupt.
	...
	----------
	  ...
	  Illegal operation attempted on a Registry key which has been marked for
	  deletion.
	...
	----------
	  ...
	  A stop control has been sent to a service which other running services are
	  dependent on.
	...
	----------
	  ...
	  When accessing a new tape of a multivolume partition, the current blocksize
	  is incorrect.
