...
## Q186339: Adobe ATM 4.0 OpenType Fonts Not Showing up in Font Menu
	...
	When you use the Adobe Type Manager (ATM) 4.0 font manager application, some or
	all of the OpenType (OTF) and Type1 fonts may not show up in some application
	font menus.
