...
{% raw %}
	...
	This article describes Terminal Server error messages 1200 to 1399.
	...
	----------
	  ...
	  The NT password is too complex to be converted to a LAN Manager password. The
	...
	----------
	  ...
	  Indicates a Windows NT Server could not be contacted or that objects within
	  the domain are protected such that necessary information could not be
	  retrieved.
	...
	----------
	  ...
	  mapped to non-generic types.
	
	Error 1361
	----------
	
	  A security descriptor is not in the right format (absolute or self-
	  relative).
	...
	----------
	  ...
	  Unable to impersonate via a named pipe until data has been read from that
	  pipe.
