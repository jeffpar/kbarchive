...
## Q168800: INFO: Visual Basic 5.0 Fixes in Visual Studio 97 Service Pack 1
	...
	Version(s): 5.0 97
	Operating System(s): 
	Keyword(s): kbList kbVS97sp1fix kbVS97sp2fix kbGrpDSVB kbvbp500sp2fix
	...
	Microsoft Visual Studio 97 Service Pack 1 contains several fixes for Visual
	...
	for Visual Basic 5.0 in the Visual Studio 97 Service Pack 1. You can find all
	these articles quickly in the Microsoft Knowledge Base by searching on
	VB5FixlistSP1. If you are only interested in a specific article below, you can
	...
	------------
	  ...
	  Q168155 : FIX: DBGrid Bound to RDC Displays a Single Row After MoveLast
	...
	-----------------
	  ...
	  Q167948 : FIX: Internet Component Download Could Fail After Using Setupkit
	...
	======================================================================
	Keywords          : kbList kbVS97sp1fix kbVS97sp2fix kbGrpDSVB kbvbp500sp2fix 
