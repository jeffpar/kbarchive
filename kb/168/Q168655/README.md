...
## Q168655: List of Bugs Fixed in SNA Server 3.0 Service Pack 2
	...
	fixed in SNA Server 3.0 Service Pack 2. Use the Qxxxxxx number that precedes the
	...
	--------------
	  ...
	  Q170071 Invokable TP Timeout May Occur With Non-Operation
	  Q170070 SNA Client Allocate ReMay Hang After AS/400 IPL
	  Q163570 CMEPLN Does Not Always Return Fully ed LU Name
	  ...
	  Q173655 Finnish SNA NT Client Unable to Connect to SNA Server 2.11
	  ...
	  Q172095 PostReplacementCount Value Is Too High
	  ...
	  Q167315 Not Set Correctly on Responses to RUI Apps
	  ...
	  Q172470 Zero-Length RU Causes Subseobs to Stop
	  ...
	  Q172471 Reefinite Response Doesn't Signal When Job Sent
	  ...
	  Q163562 TN3270 Server Does Not Handle DACTLU/ACTLU SeProperly
	...
	Additional query words: kbfix3.00.sp2 servpack
