...
{% raw %}
	...
	When you use Extensions for Windows for Workgroups to upgrade a Windows version
	...
	In a version 3.0 Microsoft Mail for PC Networks postoffice, any data that
