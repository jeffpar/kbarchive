...
{% raw %}
	...
	Choosing Print from the Visual Basic File menu to print source code truncates
	...
	This is a problem with the Hewlett-Packard LaserJet series III printer driver
