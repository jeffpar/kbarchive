...
## Q165098: WD97: Cannot Trap FormFieldOptions Command on Double-Click
	...
	When you create a macro named "FormFieldOptions", this macro will run when you
	click Properties on the shortcut menu for a form field. However, when you
	double-click the form field to display the Options dialog box for form fields,
	the "FormFieldOptions" macro does not run as expected.
