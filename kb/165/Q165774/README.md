...
{% raw %}
	...
	When you replace an existing serial mouse with a Microsoft Mouse Port mouse
	...
	A serial adapter is a device that permits a Mouse Port mouse to be used from a
	serial port.
