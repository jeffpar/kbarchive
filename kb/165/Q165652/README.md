...
{% raw %}
	...
	If a "Config File Save Required" dialog box appears when a user is attempting to
	start an SNA Server service, and the user clicks OK, the SNA Server service will
	not start correctly.
