...
{% raw %}
	...
	When you move multiple messages from Microsoft Exchange Client or Outlook to the
	...
	There is currently no means of changing the behavior of the cursor during the
