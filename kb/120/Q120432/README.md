...
{% raw %}
	...
	If you use WYSIWYG mode for Lotus 1-2-3 for MS-DOS (v2.4 or v3.4) on RISC
	platforms, no cursor appears in some menus.
	
	
	WORKAROUND
	==========
	
	Use the edit keys to select menu items.
