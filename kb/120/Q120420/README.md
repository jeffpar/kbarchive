...
## Q120420: Unable to Print Multiple Quattro Pro Spreadsheets
	...
	Only one copy of a spreadsheet prints when you request multiple copies in
	Quattro Pro's Print dialog box.
	
	CAUSE
	=====
	
	The escape sequence Quattro Pro uses to request multiple copies is not supported
	by Windows NT.
