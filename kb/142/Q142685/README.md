...
{% raw %}
	...
	When you are running Microsoft Word 97 with an ODMA-compliant document
	management system (DMS), a CloseDoc function is not issued via ODMA if the
	following are true:
	
	- You have background printing enabled.
	
	- You are printing only a selection in the document.
