...
## Q142911: Printing in Portrait and Landscape Results in Two-Page Output
	...
	When you send the first page in portrait orientation and the second page in
	landscape orientation to a printing device in duplex mode, each page is printed
	on one side. The expected result is a double-sided output.
	...
	Additional query words: prodnt postscript printer form tray
