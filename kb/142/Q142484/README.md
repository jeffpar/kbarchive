---
layout: page
title: "Q142484: Oceans: Manual Installation Instructions"
permalink: kb/142/Q142484/
---
...
## Q142484: Oceans: Manual Installation Instructions
	...
	This article provides instructions to manually install Microsoft Oceans for
	Windows, version 1.0.
	...
	3. If you are running Windows NT, copy the following file from the
	  ...
	  NOTE: After you copy this file, rename it to "Msvideo.dll" (without the
	  quotation marks).
	...
	6. Use a text editor, such as Microsoft Notepad, to make the following changes
	  to the Msoceans.ini file, which is located in the Windows folder. If the
	  Msoceans.ini file does not already exist, create one in the Windows folder
	  with these entries:
	...
	9. Add the Microsoft Oceans icons to Program Manager using the instructions in
	  the "Creating Program Manager Icons" section at the end of this article.
	...
	If you are using Windows 95 to add Microsoft Oceans to the Start Menu, do the
	following:
	...
	7. Repeat steps 3 through 6 to create shortcuts for the following items:
	  ...
	  Select A Title For The Program:  Oceans Readme
	...
	If you are using Windows Program Manager, create the Microsoft Oceans icons using
	...
	4. Type the Description and Command Line information listed below, and then
	  click OK:
	     ...
	     Description:       Microsoft Oceans
	     Command Line:      d:\oceans.exe
	
	5. Repeat steps 2 through 4 for the following items:
	
	     Description:       Oceans Read Me
	     Command Line:      d:\readme.txt
	
	     Description:       Microsoft Multimedia Catalog
	     Command Line:      d:\mmcat\catppi.exe
	
	Additional query words: multi media multimedia multi-media mmtitles kbmm kbhowto cd rom cdrom disc compact
