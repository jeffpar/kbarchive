...
{% raw %}
	...
	This article describes how to use Compression Agent to customize the compression
	methods used to compress the files on a disk.
	
	MORE INFORMATION
	================
	
	Compression Agent is included with Microsoft Plus!. You can use Compression
