...
{% raw %}
	...
	A Microsoft Schedule+ user invited to a single instance of a recurring meeting
	will receive a recurring pattern cancellation form if the recurring meeting is
	canceled.
