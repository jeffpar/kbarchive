...
{% raw %}
	...
	When you upgrade from the Microsoft Exchange Windows 3.x client to the Microsoft
	Exchange Windows 95 client, the Microsoft Exchange profiles are not migrated and
	thus must be re-created.
	
	STATUS
	======
	
	Microsoft has confirmed this to be a problem in Microsoft Exchange Server
	version 4.0. This problem has been corrected in the Service Pack 2 for Microsoft
