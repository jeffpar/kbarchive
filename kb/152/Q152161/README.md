...
## Q152161: XCLN: Survey Application Error 380 Invalid Property Value
	...
	When you start the Microsoft Exchange Survey sample application and Arial fonts
	are either corrupt or not installed, you will receive error 380, "Invalid
	Property Value." When you click on the User field, you will get runtime error
	91, "Object variable or width block variable not set."
