...
{% raw %}
	...
	When you apply the hotfix in the following Microsoft Knowledge base article,
	then update your computer to Windows NT 4.0 Service Pack 4, the Scsiport.sys
	file is not updated.
