...
## Q229759: System Command Line Shows the Wrong Date
	...
	When you run the DATE command at a command prompt to change the system date
	between two dates that occur before and after Daylight Savings Time, the new
