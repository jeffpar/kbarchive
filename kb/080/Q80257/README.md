...
{% raw %}
	...
	file HAYES24.MDM, which can be compiled with SCRCOMP.EXE:
	
	  ;*********************************************************************
	  ;
	  ;                    Microsoft Mail Script File
	  ;
	  ;       Filename: hayes24.mdm
	  ;       Date    : March 21, 1990
	  ;       Script  : Standard script file for Hayes 2400 bps modems
	  ;
	  ...
	  INITIALIZE:
	          title "Hayes 2400bps modem Script"
