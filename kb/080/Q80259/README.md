...
## Q80259: PC Gen: Contents of Modem Script File MICROCOM.MDM
	...
	file MICROCOM.MDM, which can be compiled with SCRCOMP.EXE:
	
	  ;*********************************************************************
	  ;
	  ;                    Microsoft Mail Script File
	  ;
	  ;       Filename: microcom.mdm
	  ;       Date    : March 21, 1990
	  ;       Script  : Standard script file for Microcom AX/9624c modems
	  ;
	  ...
	  INITIALIZE:
	          title "Microcom AX Family Script"
	  ...
	  init_retry:
	          ...
	          if ("OK" isin response)
	              {
	  reset_okay:
	              sendln "AT&F&C1&D2E0L0M1V0X3\\Q3\\N3\\V1\\J0"
	              wait 1
	              waitrsp 1
	  ...
	  RESET:
	          ...
	          if ("OK" isin response)
	              {
	  reset_okay:
	              sendln "AT&F&C1&D2E0L0V0X3\\Q3\\N3\\V1\\J0"
	              wait 1
	              waitrsp 1
	  ...
	  CALL:
	          ...
	          if (response = "1^M")
	            ...
	            {
	            display ">>> CONNECT 103/REL <<<"
	            $ret = 1
	            }
	          else if (response = "22^M")
	            {
	            display ">>> CONNECT 1200/REL <<<"
	            $ret = 5
	            }
	          else if (response = "23^M")
	            {
	            display ">>> CONNECT 2400/REL <<<"
	            $ret = 10
	            }
	          else if (response = "33^M")
	            {
	            display ">>> CONNECT 9600/REL <<<"
	            $ret = 12
	            }
