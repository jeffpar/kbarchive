...
{% raw %}
	...
	If you use the Reply to All command to reply to a message in your Sent Items
	folder that you originally sent to a distribution list (DL) with a read receipt,
	the reply message may stay in your Outbox until the reply message generates a
	...
	later:
	  ...
	  -------------------------------------------------------------
	  5/27/99   2:12PM  08.04.00.6526        Outllib.dll   Win9x
