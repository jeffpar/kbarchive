...
## Q147541: Undoing Goal Deletes Goal Text from New Item box
	...
	Seven Habits Tools Goals tab allows you to undo from the right click menu. When
	you add a goal, delete the goal, and undo from the right click menu, the goal
	text is deleted from New Item box.
