...
## Q318996: How To Delete Internet Cookies In Internet Explorer 5.x For The
	...
	This article describes how to delete Internet Cookies in Internet Explorer 5.x.
	...
	To delete Internet Cookies in Internet Explorer 5.x
	
	1. Start Internet Explorer.
	
	2. Click Edit, and then click Preferences.
	
	3. In Internet Explorer Preferences, double-click Receiving Files.
	
	4. Under Receiving Files, click Cookies.
	
	5. Under Cookie Settings, select the cookie(s) you want to delete.
	  Note: To select all cookies, press Command+A.
