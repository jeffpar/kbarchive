...
## Q318500: XADM: Quota System Message Is Truncated in the Russian Language
	...
	If you are using the Russian-language version of Microsoft Outlook, and the
	warning limit, the send limit, or the receive limit is exceeded, the end of the
	quota system message may be truncated.
