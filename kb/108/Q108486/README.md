...
## Q108486: Server Manager Reports Incorrect Number of Open Files
	...
	When a large number of files are open, Server Manager and the Control Panel
	Server applet lose track of the number of files that are open. The point at
	which incorrect numbers are reported varies depending on the computer and what
