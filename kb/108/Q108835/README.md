...
## Q108835: PC Gen: PODIAG.INI Entries in &#91;Server Folder Check&#93;
	...
	are contained in the [Server Folder Check] section.
	...
	a [Server Folder Check] section.
	
	MAILDATA\INI\PODIAG.INI
	-----------------------
	
	The default settings of the [Server Folder Check] section of the postoffice-
	specific PODIAG.INI file are as follows:
	...
	box. The default is 2, to check only public folders stored on the server. Use 1
	to disable the tool, 3 to check only private folders, or 4 to check both public
	and private folders. The Help file is incorrect; it reversed the meaning of the
	depth=2 and depth=3 settings.
