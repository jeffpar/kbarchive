...
{% raw %}
	...
	Mastering Microsoft Visual C++ runs on the following minimal system; however,
	performance improves with more RAM or a faster CD-ROM drive.
	...
	- Microsoft Visual C++, version 4.0 or later is required to work the lab
	  exercises.
