...
{% raw %}
	...
	The Microsoft Exchange client is unable to add a Public Folder to a Personal
	Address Book (PAB).
	
	CAUSE
	=====
	
	A user with Author permissions is unable to add a Public Folder to the PAB using
