...
## Q151493: ThinkPad 760 Audio Requires IBM ESS Audio Driver
	...
	Microsoft Windows NT does not contain drivers that support the WAVE/MIDI audio
	functions of the IBM ThinkPad 760 series.
	
	MORE INFORMATION
	================
	
	In order to use the WAVE/MIDI features of the IBM ThinkPad 760 series, you must
	install the IBM ESS Audio Driver that is available from IBM. The following files
	may be needed:
	
	  AFTPFNT1.EXE      IBM ESS Audio Driver
