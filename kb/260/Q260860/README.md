...
{% raw %}
	...
	When you click one of the following commands on the Microsoft StarLancer startup
	screen
	...
	This behavior can occur if a video adapter based on the nVIDIA RIVA 128 chipset
	...
	RIVA 128 or RIVA 128ZX reference driver from the following nVIDIA Web site:
