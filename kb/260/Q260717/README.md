...
## Q260717: StarLancer: Game Hangs When You Start New Mission
	...
	When you start a new mission in Microsoft StarLancer, the game may stop
	responding (hang).
	...
	- You change the screen resolution in the game from 640 x 480 pixels to 1024 x
	  768 pixels immediately before you start the new mission.
	
	- A 3Dfx Voodoo3 video adapter is installed in your computer.
	...
	driver for your video adapter from the following 3Dfx Web site:
