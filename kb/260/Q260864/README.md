...
{% raw %}
	...
	When you play Microsoft StarLancer, lighting effects may not be displayed when
	engines are engaged or weapons are fired.
	
	CAUSE
	=====
	
	This behavior can occur if a Matrox Productiva G100 AGP video adapter is
