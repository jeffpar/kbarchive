...
## Q234896: XCLN: How to Manage Outlook 98 with System Policies
	...
	Version(s): WINDOWS:
	Operating System(s): 
	Keyword(s): kbnetwork kbOutlook98 kbOutlook850kbfaq
	...
	System policies for Outlook 98 are a powerful mechanism for increasing control
	and management of Outlook 98 client computers across a network. System policies
	...
	Outlook 98 System Policy Template
	---------------------------------
	
	The System Policy Editor settings specific to Outlook 98 are in the Outlk98.adm
	file. This template can be obtained from the Microsoft Outlook 98 Deployment Kit
	(ODK). For Windows 95 and Windows 98 system policies, copy this template to the
	Windows\Inf folder. For Windows NT, copy this template to the Winnt\Inf folder.
	
	NOTE: Outlook 98 system policies allow you to control both Outlook 97 and Outlook
	98 clients by using the Outlk98.adm file. However, Outlook 98-specific policy
	settings do not work on Outlook 97 clients; they only affect Outlook 98
	clients.
	
	For additional information about managing Outlook with system policies, click the
	...
	To Open the Outlk98.adm Template:
	...
	4. Click the Outlk98.adm file, and then click Open.
	...
	NOTE: For more information about Outlook 98 system policies, see the Outlook
	Deployment Kit (ODK) documentation.
	
	Additional query words: ol98
	
	======================================================================
	Keywords          : kbnetwork kbOutlook98 kbOutlook850 kbfaq
