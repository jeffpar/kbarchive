...
## Q234557: Executable with Specially Malformed Image Header Crashes Windows
	...
	If an executable file with a specially-malformed image header is executed, it
	will cause a system failure and you may receive the following STOP error message
	on a blue screen:
	...
	This hotfix has been posted to the following Internet location as Krnlifxi.exe
	(x86) and Krnlifxa.exe (Alpha):
	...
	This error condition does not affect Microsoft Windows 95 or Microsoft Windows
	98.
