...
## Q232275: Multithreaded Write Routine May Corrupt Data on FAT Partition
	...
	When multiple threads are asynchronously writing to non-overlapping parts of a
	file, immediately after another thread extends the file, part of the file can
	become corrupted with zeros. This only occurs when the file is on a FAT file
	system.
