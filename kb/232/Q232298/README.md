...
## Q232298: STOP 0x0000000A in SFMAtalk Because of Invalid Frame
	...
	If Services for Macintosh (SFM) is installed on a computer running Windows NT
	Server 4.0, a blue-screen error message with a trap in 0x0000000A may be
	displayed when you start the computer and the logon screen appears. If you
	remove SFM, the computer performs as expected. If you start the computer with
	SFM installed, but on a hub by itself, it also performs as expected.
