...
{% raw %}
	...
	When the length of the path of the system environment variable is longer than
	517 characters, and you attempt to create a completed report file on Winmsd.exe,
	Winmsd.exe causes an access violation and the report file becomes corrupted.
