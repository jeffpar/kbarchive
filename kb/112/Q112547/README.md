...
## Q112547: Dial-Up Networking Hangs After Failed Multilink Attempt
	...
	When you attempt to make a multilink Remote Access Service (RAS) connection that
	fails, the Dial-Up Networking dialog box may stop responding (hang) or freeze.
