...
## Q112637: STOP Message on MIPS Computer Caused by NET Command
	...
	A MIPS-based computer running Windows NT may halt with a STOP message if you
	connect to it from another Windows NT computer (non-MIPS) and use the NET
	command. The STOP message is 0x0000001E.
