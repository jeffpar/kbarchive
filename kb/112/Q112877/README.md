...
{% raw %}
	...
	Version 3.2 of Microsoft Mail for Windows does not differentiate properly
	between commas and apostrophes. For example, the following character
	combinations are confused by the name finder service:
