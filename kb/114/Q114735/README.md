...
{% raw %}
	...
	If you have Service Pack 2 installed and have a modem connected to COM2, your
	modem may dial slowly, buffer overflow messages may appear, and the modem
	software may stop operating. These problems occur when you are using a 16-bit
