...
{% raw %}
	...
	When you have a dot matrix printer connected to a Windows NT workstation or
	Windows NT Advanced Server, the printer controls do not function until after the
	printer has printed a document.
	
	WORKAROUND
	==========
	
	Print a page on the printer. After the job has finished printing, the controls
	on the printer function properly.
	...
	Additional query words: prodnt Online
