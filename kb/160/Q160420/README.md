...
## Q160420: Changing Colors on Cirrus Logic Cards to 65k Can Cause Stop
	...
	Cirrus Logic Video can cause a 0x0000001E stop error when set to 65536 colors
	with a screen resolution of 600 X 800.
	
	WORKAROUND
	==========
	
	This problem can be fixed by installing Cirrus.dll and Cirrus.sys from Window NT
	...
	Additional query words: Cirrus 0x1E video prodnt
