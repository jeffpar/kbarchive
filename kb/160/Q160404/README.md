...
## Q160404: Madge EISA Stops Responding on Alpha in Windows NT 4.0
	...
	The network stops responding on a DEC Alpha with Madge EISA network card
	installed.
	
	CAUSE
	=====
	
	The network goes into an infinite loop when processing remote files.
	...
	Additional query words: prodnt network hang NT Madge
