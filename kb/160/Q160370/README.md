...
## Q160370: Stop Screen 0x00000050 Caused by Fs_rec.sys
	...
	Under high stress conditions, Fs_rec.sys can cause CDFS (the Compact Disc File
	System) to cause a system crash (trap).
	
	WORKAROUND
	==========
	
	The fixed Fs_rec.sys file is available in Windows NT 4.0 Service Pack 2 and
	later.
