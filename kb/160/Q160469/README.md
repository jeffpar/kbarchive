...
## Q160469: Pentium Processors Are Not Detected on Systems Running OS/2
	...
	Operating System(s): 
	Keyword(s): kb3rdparty kbInventory smsinv smsgeneral kbArtTypeINF
	...
	When Systems Management Server inventories a system running OS/2, it will not
	report the presence of a Pentium processor. It will correctly report 286, 386,
	and 486 processors.
	...
	======================================================================
	Keywords          : kb3rdparty kbInventory smsinv smsgeneral kbArtTypeINF 
