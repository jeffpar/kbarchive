...
{% raw %}
	...
	If you hide the document text using the Show/Hide Document Text button on the
	...
	To work around this problem, click the Show/Hide Document Text button on the
