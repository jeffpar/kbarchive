...
## Q177988: XADM: BCC Line Is Viewable from Recipient's Mailbox
	...
	When you run Microsoft Exchange Server version 5.0 and use a Microsoft Outlook
	client, you may be able to view the contents of the BCC line on mail sent to
	you.
