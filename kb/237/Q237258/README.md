...
## Q237258: WD97: Page Size Changes When You Edit Document Object
	...
	In PowerPoint 97, when you edit an embedded Word object that contains a table or
	drawing object and then move the Word object, the Word page size shrinks or
	grows each time you move the object.
	
	
	WORKAROUND
	==========
	
	To work around this problem, reset the page size by using the Word Page Setup
	dialog box.
	...
	Additional query words: wd97 ppt97 embedded object move pagesize
