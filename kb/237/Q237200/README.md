...
{% raw %}
	...
	When you copy all or part of a Word table that contains form fields and paste it
	into a new Word document as a Word document object, some of the form fields are
	not visible.
	...
	Additional query words: wd97 word97 form field copy paste visible missing qfe
