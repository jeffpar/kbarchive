...
## Q237278: WD97: AV When Programmatically Applying ListTemplate
	...
	When you programmatically apply a ListTemplate that does not exist, you receive
	an access violation similar to the following:
	
	  The instruction at "0xXXXXXXXX" referenced memory at "0x00000000". The memory
	  could not be "read".
