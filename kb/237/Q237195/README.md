...
{% raw %}
	...
	criterion, text with the specified formatting is not found if it is in a table.
	...
	Additional query words: wd 97 word97 find replace table paragraph formatting
