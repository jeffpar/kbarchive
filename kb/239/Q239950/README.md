...
{% raw %}
	...
	A white paper describing Microsoft's implementation of the Windows Internet
	...
	WINS provides dynamic NetBIOS-name-to-IP-address registration and resolution.
