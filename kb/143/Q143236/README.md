...
{% raw %}
	...
	When you try to change your Windows NT Domain password from a Microsoft Exchange
	client for Windows by clicking on Tools, Options, Exchange Server, and Password,
	you will receive the following error if the Windows NT Server's machine name is
