...
## Q137514: Older ESS Sound Tools Incompatible with Windows 95
	...
	Certain programs, such as Talking Calculator, are preinstalled on computers
	containing an ESS Technologies ESS688 sound card. These programs may produce any
	of the following symptoms in Windows 95:
	...
	The 16-bit ESS Technologies programs listed below are not compatible with
	Windows 95.
	
	RESOLUTION
	==========
	
	Contact ESS Technologies for information about upgrading these programs to
	versions that are compatible with Windows 95.
	
	MORE INFORMATION
	================
	
	The following ESS Technologies programs are known to cause the problems
	...
	Many of these programs use a proprietary waveform format. These files have an
	.aud extension. Windows 95 cannot recognize this format.
