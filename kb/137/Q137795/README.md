...
{% raw %}
	...
	When you use the remote diagnostics Memory feature on a remote MS-DOS client, a
	list of program/driver names and their addresses should appear. Instead, all
	program names except COMMAND.COM are displayed as "N/A".
