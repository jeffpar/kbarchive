---
layout: page
title: "Q298693: MSN Explorer (MSN Version 6.1) Sign-in And Sign-up Error Message"
permalink: kb/298/Q298693/
---
...
## Q298693: MSN Explorer (MSN Version 6.1) Sign-in And Sign-up Error Message
	...
	This error appears when you have not selected an option on the MSN Terms of Use
	page. Select I accept or I decline, and then click Continue.
	
	Note: Setup ends if you select I decline. You will have to start over with Setup
	if you wish to continue at a later time.
	
	Error Message: You have declined the agreement.  This will cancel the sign up process.  Are you sure you want to cancel signup for an account with MSN?
	-------------------------------------------------------------------------------------------------------------------------------------------------------
	
	You declined the Member Agreement. You must accept the Member Agreement before an
	account can be created. Select I Accept, and then click Continue.
