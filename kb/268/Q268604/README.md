...
{% raw %}
	...
	When you play a game included in Microsoft Plus! Entertainment Pack: Cards &
	Puzzle Edition, the program may stop responding (hang).
	...
	- An ASUS motherboard with a built-in SoundMax sound card is installed in your
	  computer.
	...
	to obtain and install the latest sound driver for your sound card.
	...
	Additional query words: 1.00 msgame bicycle hangs freeze lock
