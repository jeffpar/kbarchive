...
## Q268610: WD97: Word Crashes When Starting Word with Hyperlink from IE
	...
	When you open an embedded session of Word from Microsoft Internet Explorer and
	then select a command, you receive an error message similar to the following:
	
	  The instruction at "0x30301a73" referenced memory at "0x00000000". The memory
	  could not be "read".
	
	Winword.exe may still appear in the list of active processes.
	...
	IMPORTANT: Microsoft Word 97 post-service release fixes are cumulative. The
	...
	Additional query words: word97 wd97 ie embedded errmsg crash
