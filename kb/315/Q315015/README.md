...
{% raw %}
	...
	An access violation may occur in Nddeagent.exe during the logon process.
	
	CAUSE
	=====
	
	This problem occurs if the ClipBook service (Clipsrv.exe) cannot be started.
	...
	later:
	  ...
	  -------------------------------------------------------
	  21-Dec-2001  17:27  4.0.1381.7119  14,096  Nddeagnt.exe
