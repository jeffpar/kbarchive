...
## Q194784: INFO: Controls Shipped in Visual Basic 6.0
	...
	Version(s): 6.0
	Operating System(s): 
	Keyword(s): kbtophit kbCtrl kbInternet kbVBp kbVBp600 kbGrpDSVB kbFAQ kbVBp600FAQ kbCompatVers
	...
	The ActiveX component files installed depend on the options chosen during
	installation. Many files are not installed with the product and must be
	installed separately. Instructions for installing these controls will be in a
	Readme.txt file in the same directory as the uninstalled controls.
	...
	The following is a summary of ActiveX control files shipped with the different
	...
	*E = Enterprise Edition
	...
	The following controls are contained inside the Visual Basic executable file and
	...
	The components listed below are arranged by the edition in which the component
	ships and the file name. Each file name contains the following:
	...
	components are included in the Professional Edition:
	...
	ActiveX components are included in the Enterprise Edition. Unless otherwise
	documented, the following controls are stored in Disk 1:
	...
	General file versioning information may be found in the DLL Help Database.
	
	For additional information, please see the following article in the Microsoft
	Knowledge Base:
	
	Q168243 HOWTO: Search the Knowledge Base for Internet Explorer Articles
	
	
	Additional query words:
	
	======================================================================
	Keywords          : kbtophit kbCtrl kbInternet kbVBp kbVBp600 kbGrpDSVB kbFAQ kbVBp600FAQ kbCompatVers 
