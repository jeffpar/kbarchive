...
## Q194555: X400: Gateway Hangs Sending Two Messages to Very Large DLs
	...
	When you send two messages to very large distribution lists (DLs) through the
	Microsoft Mail Gateway to X.400, the gateway may be unable to process the
	messages and may stop responding (hang).
