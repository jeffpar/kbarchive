...
{% raw %}
	...
	While you are connected to MSN, The Microsoft Network, the MSN Quick View icon
	may disappear from the Windows taskbar.
	
	CAUSE
	=====
	
	This behavior can occur if any program you are running on your computer stops
