...
## Q194853: PC Rmt: Remote Mail Client Can't Address Local FFAPI Gateway PO
	...
	Users do not see the local users of their own FFAPI gateway postoffice.
	
	CAUSE
	=====
	
	The FFAPI postoffice is not defined as an external postoffice in the Network
	list as it is the local postoffice.
