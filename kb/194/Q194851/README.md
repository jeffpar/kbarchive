...
## Q194851: PC Rmt: Textborder Is Off in Remote Client
	...
	Remote mail messages come out of the gateway UUENCODED.
	
	CAUSE
	=====
	
	The remote client cuts off the text border one character short. The gateways
	uses this field to strip off the header.
