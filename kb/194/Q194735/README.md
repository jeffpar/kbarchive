...
## Q194735: PC WRmt: Remote Mail Errors Using Custom Script
	...
	The Windows Remote client does not respond to incoming calls using custom
	script.
	
	CAUSE
	=====
	
	The Windows client is not making proper use of the Waitrsp command in the modem
	script.
