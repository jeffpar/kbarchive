...
## Q194603: PC MMTA: No Recipient Found while Building the Mailing List
	...
	When either the Windows NT multitasking message transfer agent (MMTA) or the
	OS/2 MMTA is transferring mail using X.25 connections, you may see the following
	error message in the session log.
	
	  No recipient found while building the mailing list.
	
	The External program may stop responding (hang). If this occurs, it may be
	necessary to restart the computer the External program is running on, and
	restart External.exe.
