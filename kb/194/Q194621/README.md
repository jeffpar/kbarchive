...
## Q194621: Print Screen in 3270 Applet Does Not Support Greek Code Page
	...
	When using the Print Screen feature within the 3270 applet, some Greek
	characters may not print correctly even though they are displayed correctly
	within the applet.
	
	CAUSE
	=====
	
	This functionality was not originally included in the 3270 applet.
