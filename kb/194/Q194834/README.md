...
## Q194834: List of Bugs Fixed in Windows NT 4.0 and TSE SP4 (Part 2)
	...
	This article is part three of a current listing of the article numbers for bugs
	...
	------------------------
	  ...
	  Q177868 SnmpMgrTrapListen API Returns ERROR_SERVICE_NOT_ACTIVE Error If Not
	  Administrator
	  Q177983 Stop 0xA in Netbt.sys with Greater Than 64 Adapters
	  Q178109 Roving Profiles for Windows 95 Clients Stop Working
	  Q178110 File and Print Services for NetWare Does Not Allow OS/2 Clients to
	  Open Files
	  ...
	  Q178364 Macintosh Clients See Files on Windows NT Server Constantly Moving
	  Q178381 SNMP Leaks Memory If the OID Cannot Be Decoded
	  Q178393 SQL Server Hangs When Sending a Message Using SQLMail
	  Q178413 Windows NT System May Stop Responding (Hang) When Running a Filter
	  Driver Such As McAfee Virus Filter
	  ...
	  Q179147 Access Denied Error Starting Program When Directory Named Program
	  Exists
	  Q179156 Updated TCP/IP Printing Options for Windows NT 4.0 SP3 and Later
	  Q179157 Stop 0xA in Tcpip.sys When Token Ring Source Routing Data Exceeds 18
	  Bytes
	  ...
	  Q179553 Access Violation in PolEdit When Defining Allowed Windows
	  Applications
	  Q179741 System May Stop with a STOP 0x0A Due to Duplicate Free in Afd.sys
	  ...
	  Q180168 Novell Client 32 for Windows 95 Displays Duplicate Files on FPNW
	  Q180356 NWConv Fails to Apply Correct Group Permissions
	  Q180532 Xircom PC Card Fails to Function
	  Q180622 "STOP: 0x0000001E with STATUS_INSUFFICIENT_RESOURCES with More Than
	  800,000 Files on a Macintosh Volume"
	  Q180648 Windows NT 4.0 Traps with a Stop 0x00000024 in NTFS or Stop
	  0x0000000a
	  ...
	  Q181120 Manual Dial Dialog Fails to Appear when Logging on When Logging on
	  ...
	  Q181859 Stop 0x0000000A When Using UltraBac to Back Up a SQL Server or Reading
	  from a Message Type Pipe
	  ...
	  Q182441 Full Synchronization from Windows NT PDC to LanMan Server May Fail
	  ...
	  Q182918 Account Lockout Event also Stored in Security Event Log on Domain
	  Controller
	  ...
	  Q183664 NDS Logon Scripts Do Not Execute Correctly When Using Objects from
	  ...
	  Q184072 HasOverlappedIoCompleted Returns TRUE While GetOverlappedResult()
	  Returns 0 Bytes Transferred
	  Q184101 Very Small Single and Double-Precision Values Are Rounded to Zero on
	  Alpha Computers
	  Q184132 The Value Entered Does Not Match with the Specified Type
	  Q184137 URL For _AuthChangeUrl Is Incorrect When Connecting Via Proxy Server
	  ...
	  Q184758 STOP 0x78 When NonPagedPoolSize > Seven-eighths of Physical Memory
	  ...
	  Q184881 Reverse Lookups with BIND Earlier Than 4.8.3 Fail with Unknown Host
	  Error Message
	  ...
	  Q184998 RDR May Read Or Write from Wrong File If File Is Memory Mapped and
	  ...
	  Q185260 User Accounts May Get Locked out After Entering Wrong Password Using
	  RAS
	  Q185300 STOP 0x24 in Ntfs.sys Function NTFSMoveFile()
	  Q185323 Pool NonPaged Bytes Not Accurately Calculated for User Mode Processes
	  by Perfmon Counters
	  ...
	  Q185773 NTFS Corruption on Drives Larger Than 4 GB When Using Windows NT
	  ExtendOEMPartition
	  ...
	  Q185945 Access Violation in win32k!HMMarkObjectDestroy in Japanese and Korean
	  Windows NT
	  Q186051 Archive Bit Is Not Set with File or Directory Rename
	  Q186078 Name Resolution May Fail If NetBios Name Has ASCII Sixteenth
	  Character
	  Q186081 STOP 0x0000000A When Restoring Tape
	  Q186101 FTP Client Does Not Show the Correct Transfer Size for Files Larger
	  Than 4 GB
	  ...
	  Q186494 Event ID 517 Not Created When Security Log Is Cleared by a Non-System
	  Administrator
	  Q186495 WOW Leak Launching Many Instances of a 16-Bit Application
	  Q186669 "FPNW Logout.exe Incorrectly Reports Year on or After Jan. 1, 2000"
	  ...
	  Q187277 The FTP PORT Command Fails in IIS 3.0 When the System Has Multiple
	  ...
	  Q187555 WINS Incorrect Version ID Assigned During Scavenging or Consistency
	  Check
	  Q187576 Stop 0x0000000A May Occur in TCP/IP While Invalidating a Cached Route
	  Table Entry
	  ...
	  Q187709 Windows NT 4.0 Domain Name Resolver Caches Responses Regardless of
	  Registry Setting
	  ...
	  Q187884 CoCreateInstance Under Stress on Multiple Threads at the Same Time
	  Causes Long Hangs or Returns Failure
	  ...
	  Q187964 MGI PhotoSuite May Paste Screenshots As Garbage Or an Access Violation
	  Occurs
	  Q187999 Access Denied Occurs with Personalization System & Membership
	  ...
	  Q188342 500 Server Error Posting Data from Form with SSL & NTLM Required
	  Q188414 Random Stop 0x0000000A When Running IPX over Token Ring
	  Q188424 WD97: Multilayered Display Driver Produces Black Line in Word When
	...
	Additional query words: servpack SP1 SP2 SP3 SP4 bug fix qfe compact disc nt4sp4fixlist
