...
## Q194340: Access Violation When Using Rcp.exe to Copy to UNIX
	...
	When you copy a file from a computer running Windows NT Server 4.0 or Windows NT
	Workstation 4.0 to a UNIX server using the rcp utility, you may get an access
	violation in Rcp.exe on the Windows NT computer from which you are copying.
	...
	The Rcp.exe utility copies files to and from a computer running the RCP service.
	
	Additional query words: RCP UNIX
