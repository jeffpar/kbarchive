...
## Q194592: XFOR: OV/VM Connector Diagnostic Logging Registry Settings
	...
	This article describes how to set the diagnostics logging levels for the OV/VM
	...
	version of the OV/VM Connector or later. This version, or later versions of the
	...
	The diagnostics logging information for the Microsoft Exchange OV/VM Connector is
	saved in the following location of the Windows NT registry (in the components
	key):
	
	  HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\LMS-PROFS
	...
	Additional query words: Verbose logging
