...
{% raw %}
	...
	If you start the Microsoft Mail Gateway to X.400 using the -MR option, the
	Recv.log file is not updated when you receive messages through the gateway. If
	the file does not already exist, it is not created when you receive messages.
