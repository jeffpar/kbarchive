...
{% raw %}
	...
	The Echo and Display commands are used in scripts that are processed by
	Microsoft Mail Remote for Windows when it starts. If you create a script file
	that contains these commands, and then start Remote for Windows, the commands
	are ignored.
