...
{% raw %}
	...
	If an access number with the same area code as your own area code is a long
	...
	MSN automatically dials a telephone number with an area code the same as your
