...
{% raw %}
	...
	Error and warning messages are not correctly handled by the System Log. When you
	attempt to view a message in Event Viewer, the following is displayed:
	
	  The description for event id (x) in source (XXX) could not be found...".
