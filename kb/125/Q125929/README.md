...
{% raw %}
	...
	When you run the Windows NT Setup Help program (SETUPNT.HLP) and the Windows NT
	Setup program (SETUP.EXE) concurrently, two versions of Windows NT Setup are
	listed in the Task Manager task list.
