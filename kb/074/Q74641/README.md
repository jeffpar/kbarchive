...
{% raw %}
	...
	This article contains a list of the required driver versions for popular mice to
	operate correctly with the Microsoft MS-DOS version 5.0 or later Shell.
	...
	The products included here (except the Microsoft Mouse) are manufactured by
