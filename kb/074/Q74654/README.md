...
{% raw %}
	...
	CTRL+SPACEBAR allows you to alternatively select and deselect a file in MS-DOS
	version 5.0 Shell.
	...
	When selecting a new directory from the directory tree, if you decide to scan
