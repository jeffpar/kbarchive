...
## Q86003: PC Win: Space Requirements Incorrect on Custom Setup
	...
	When you run the Custom Setup for version 3.0, 3.0b, or 3.2 of Microsoft Mail
	for Windows, the required disk space reported might be incorrect depending on
	whether the files already exist on the disk.
