...
{% raw %}
	...
	Microsoft Schedule+ for Windows can import Windows Calendar files; however, if
	the imported files contain notes, the imported notes will replace any existing
	notes.
