...
{% raw %}
	...
	When a message is sent to a shared folder from a Microsoft Mail for PC Networks,
	MS-DOS workstation, then opened in version 3.0, 3.0b, or 3.2 of Microsoft Mail
	for Windows, the header information is displayed in the message text.
