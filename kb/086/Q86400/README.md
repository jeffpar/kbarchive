...
{% raw %}
	...
	In Microsoft Mail for Presentation Manager, pressing the right mouse button over
	a push button results in the same behavior as pressing and holding the left
	button. Pressing the left button restores things to normal.
