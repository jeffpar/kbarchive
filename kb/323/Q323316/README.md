...
{% raw %}
	...
	4. Add the correct counter. On the Edit menu, click Add to Log, click to select
	  Active Server Pages, and then click Add.
	...
	6. In the New Log Settings dialog box, type a name for the log, such as
	  "ActiveServerPagesHigh".
	
	7. On the General tab of the ActiveServerPagesHigh log, click Add Objects in the
	  Counters section.
	
	8. In the Performance Objects list, click Active Server Pages, and then click
	  Add.
	...
	10. Calculate the correct time frame, and then set the start time to one hour
	  ...
	  4:00 A.M. PST every Friday, schedule a new log (such as
	  ActiveServerPagesLow) to run from 1:00 A.M. to 5:00 A.M. PST every Friday.
