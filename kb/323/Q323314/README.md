...
{% raw %}
	...
	7. On the General tab of the MemoryHigh log, click Add Objects in the Counters
	  section.
	
	8. In the Performance Objects list, click Memory, and then click Add.
	...
	10. Calculate the correct time frame, and then set the start time to one hour
	  ...
	  4:00 A.M. PST every Friday, schedule a new log (such as MemoryLow) to run
