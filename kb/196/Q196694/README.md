...
{% raw %}
	...
	After you install Windows NT 4.0 on an extended partition on a computer using an
	IBM ServRaid adapter, you may receive the following error message when you
