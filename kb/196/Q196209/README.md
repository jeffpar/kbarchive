...
{% raw %}
	...
	WINS replication time does not start as scheduled by the Start Time as it is
	defined. For example, if it starts at 05:00 and runs till 07:30, it starts the
	next day at 07:30, instead of again at 05:00.
