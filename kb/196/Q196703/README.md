...
{% raw %}
	...
	This is the second article in the series and lists the files in the Windows NT
	4.0 Workstation \WINNT\SYSTEM32 (default) folder after this step in the Visual
	FoxPro 6.0 installation, which checks for Windows NT Service Pack 3 (SP3) and
	installs it if it is not found.
	
	MORE INFORMATION
	================
	
	Directory of \WINNT\SYSTEM32 (after installing Windows NT SP3):
	
	  745 File(s)   58,529,871 bytes
	
	Files that were added or modified by installation of Windows NT SP3:
