...
## Q196708: INFO: Files Remaining in NT&#92;SYSTEM32 Folder After VFP6 Removal
	...
	This is the fifth article in the series and lists the files in the Windows NT 4.0
	Workstation \WINNT\SYSTEM32 (default) folder after removing your recent
	installation of Visual FoxPro 6.0.
	
	MORE INFORMATION
	================
	
	Directory of \WINNT\SYSTEM32 (after removing Microsoft Visual FoxPro version
	6.0):
	
	    944 Files        92,254,231 bytes
	
	Files that were deleted by removal of Microsoft Visual FoxPro version 6.0:
