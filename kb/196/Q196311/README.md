...
{% raw %}
	...
	After you pause and then restart the Microsoft Exchange Chat Server service, the
	Chat Service Total Client Connects counter in Performance Monitor does not reset
	to "0".
