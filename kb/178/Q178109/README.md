...
{% raw %}
	...
	After you edit a user account with the User Manager tool that ships with Citrix
	WinFrame, roving profiles do not work correctly.
	
	
	CAUSE
	=====
	
	This is caused by incorrect interaction between the domain controller and the
	client concerning the field UserParametersInformation.
