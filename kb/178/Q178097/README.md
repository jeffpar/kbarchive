...
## Q178097: XADM: Delete Control Message Does Not Work in NNTP Protocol
	...
	This problem occurs in the Microsoft Exchange Server Administrator program. When
	you select the Protocols container, and then open the NNTP Control Messages tab,
	and click the Delete option, the selected Control Message is not deleted.
