---
layout: page
title: "Q178182: Encarta 97 Err Msg: The Registration Wizard Cannot Run..."
permalink: kb/178/Q178182/
---
...
## Q178182: Encarta 97 Err Msg: The Registration Wizard Cannot Run...
	...
	When you attempt to access Online features of Encarta 1997 Encyclopedia for
	Windows, you may receive the following error message:
	
	  The registration wizard cannot run because the information it requires from
	  the system is either unavailable or incorrect.
	
	CAUSE
	=====
	
	This behavior can occur if Encarta 97 cannot locate your Web browser.
	...
	3. On the Options menu, click Settings.
	  ...
	  Cannot find the file 'http://encarta.msn.com'
	     ...
	     a default Web browser is not set in Windows. If you install (or reinstall)
	     a 32-bit Web browser, it is automatically set as the default Web browser
	     in Windows.
	  ...
	  If you do not know the location of your Web browser, contact the company that
	...
	Additional query words: 1997 multi media multi-media multimedia mmtitles yearbook updates
