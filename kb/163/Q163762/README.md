...
{% raw %}
	...
	When you use the Electronic Forms Designer for Microsoft Exchange, if you drop a
	list box into a Tab field and then switch to another page in the Tab field, the
