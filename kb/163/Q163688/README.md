...
{% raw %}
	...
	It is not possible to use the Setup Editor to change the default installation
	directory of the Exchange Client to a directory on drive D; Setup still uses
	drive C instead.
