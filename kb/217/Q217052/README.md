...
## Q217052: Modem Configuration File Is Not Copied During Modem Installation
	...
	When you use the Modems tool in Control Panel to install a new modem and use the
	Have Disk option, the modem's .inf configuration file may not be copied from the
	specified location to the %SystemRoot%\Inf folder.
