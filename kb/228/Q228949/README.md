...
## Q228949: Midtown Madness: Sparks Do Not Appear During Collisions
	...
	When you play Microsoft Midtown Madness, sparks may not appear when you collide
	with other vehicles.
	
	CAUSE
	=====
	
	This behavior can occur if a video adapter based on the Voodoo2 chipset is
	...
	Additional query words: 1.00 msgame midmad collisions objects cars trucks
