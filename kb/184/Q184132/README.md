...
## Q184132: Err Msg: Value Entered Does Not Match with the Specified Type
	...
	When you try to add a Custom Date using the year 00 on the Custom tab of the
	properties sheet for a Microsoft Office document, you receive the following
	error message:
	
	  The value entered does not match with the specified type. The value will be
	  stored as text.
	...
	Additional query words: word excel powerpoint access doc xls mdb ppt file 4.00
