...
## Q184296: List of Bugs Fixed in SNA Server 3.0 Service Pack 3
	...
	- Microsoft SNA Server, versions 3.0, 3.0 SP3 
	-------------------------------------------------------------------------------
	...
	fixed in SNA Server 3.0 Service Pack 3. Use the Qxxxxxx number that precedes the
	...
	================
	  ...
	  Q176188 SNA Link Access Violation in ibmx25!os,wtime
	  ...
	  Q178074 RUI,TERM Fails to Return When lua,resv56[2] Is Set in RUI,INIT
	  Q178089 Thorn,Icelandic,Capital cannot be Mapped to a Macro in a PDF
	  ...
	  Q180703 SLI,BID May Return LUA,CANCELLED LUA,TERMINATED
	  Q180704 SLI,CLOSE May Hang if CICS Doesn't Respond to SHUTC
	  Q180705 APPC DISPLAY Call May Return AP,COMM,SUBSYSTEM,ABENDED.
	  Q180706 Incoming X.25 Host Connection Indicates Primary Link Role
	  Q180708 SLI,OPEN May Fail With LUA,STATE,CHECK LUA,NO,SLI,SESSION
	  ...
	  Q180791 An ATTACH May Fail When Using Set,CPIC,Side,Information
	  ...
	  Q180953 Err Msg: "Missing Component" When Applying Service Pack
	...
	======================================================================
	Keywords          :  
	Technology        : kbAudDeveloper kbSNAServSearch kbSNAServ300 kbSNAServ300SP3
	Version           : WINDOWS:3.0,3.0 SP3
	Issue type        : kbinfo
	Solution Type     : kbfix
