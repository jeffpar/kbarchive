...
## Q184053: XCON: Fax from Lotus Fax Server to Exchange Is Not Readable
	...
	When the Lotus Fax Server for cc:Mail forwards fax messages to Exchange
	recipients via the Microsoft Exchange Connector for Lotus cc:Mail, the fax
	messages in the Inbox are without the file name extension and are not readable.
