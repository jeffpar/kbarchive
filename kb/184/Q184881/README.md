...
{% raw %}
	...
	Microsoft Domain Name System (DNS) servers do not have an equivalent to a BIND
	directive called fake-iquery. If old BIND clients use Microsoft DNS servers, the
	NSLOOKUP fails.
