...
## Q197460: Access Violation Occurs when Client Certificates are Required
	...
	Microsoft Internet Explorer 3.02 or other applications using Secure Socket Layer
	(SSL) may access violate when Internet Information Server requires client-side
	certificates.
