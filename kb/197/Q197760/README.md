...
{% raw %}
	...
	In Microsoft Excel, if you copy cells that are formatted for center or bottom
	...
	To work around this problem, use the Center Vertically button on the Tables And
