...
## Q109699: PC WSPlus: Sending a Meeting Request for a Busy Resource
	...
	In versions 1.0 and 1.0a of Microsoft Schedule+ for Windows, attempting to send
	a meeting request that includes a local busy resource allows you to back out to
	select a new time or resource. However, Schedule+ books the meeting for the
	original time.
