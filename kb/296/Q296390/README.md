---
layout: page
title: "Q296390: ALS Windows 2000 Network Infrastructure Administration Comments"
permalink: kb/296/Q296390/
---
...
## Q296390: ALS Windows 2000 Network Infrastructure Administration Comments
	...
	- MSPRESS Academic Learning Series Microsoft Windows 2000 Network Infrastructure Administration ISBN 0-7356-0989-6 
	-------------------------------------------------------------------------------
	...
	2000 Network Infrastructure Administration, ISBN 0-7356-0989-6.
	
	The following topics are covered:
	
	- CD-ROM: Missing Media Files
	
	- CD-ROM: Correction To Step 26 in LabSetup.doc
	
	- CD-ROM: Correction To Step 35 in LabSetup.doc
	
	- Lab Manual, Pages 34 And 41: Incorrect ARPA IP Address
	
	- Lab Manual, Page 36: Correction To Step 10
	
	- Lab Manual, Page 40: Secondary Should Be Alternate
	
	- Lab Manual, Page 41: Correction To First Step 7
	...
	The Student CD-ROM should contain a Media folder that includes multimedia video
	files. These files were inadvertently left off of the CD-ROM. The missing files
	are available in the self-extracting executable file Media.exe.
	
	The following file is available for download from the Microsoft Download Center:
	
	  Media.exe
	  (http://download.microsoft.com/download/MSPressPub/mspress/1.0/NT5/EN-US/Media.exe)
	...
	On the Instructor CD, in LabSetup.doc, on page 9, change:
	"26. Click Next to accept the Workgroup role."
	
	To:
	"26. Click Next, the Workgroup or Computer Domain window appears;
	Select 'Yes, make this computer a member of the following domain', type in
	'Domain1', then follow the instructions."
	
	
	CD-ROM: Correction To Step 35 in LabSetup.doc
	---------------------------------------------
	
	On the Instructor CD, in LabSetup.doc, on page 5,
	
	Change:
	"35. Click Next to install the selected networking components"
	
	To:
	"35. Click Next, the Workgroup or Computer Domain window appears; and then click
	Next."
	...
	In the Lab Manual, on page 34, in step 11, and on page 41, in step 13,
	...
	In the Lab Manual, on page 36, in step 10,
	
	Change:
	"10. Type nslookup hosta.studentxx.com..."
	
	To:
	"10. Type hosta.studentxx.com..."
	
	
	Lab Manual, Page 40: Secondary Should Be Alternate
	--------------------------------------------------
	
	In the Lab Manual, on page 40, in the first step 3,
	
	Change:
	"..and then set the secondary DNS server..."
	
	To:
	"..and then set the alternate DNS server..."
	
	
	Lab Manual, Page 41: Correction To First Step 7
	-----------------------------------------------
	
	In the Lab Manual, on page 41, in the first step 7,
	...
	On page 247, in the first bulleted section, there is a list of the steps for
	enabling the "dynamic update for DHCP clients that do not support dynamic DNS
	updates" option through the DNS management console. This is incorrect, as this
	option is enabled through the DHCP, not DNS, management console.
	...
	Additional query words: ALS 0-7356-0989-6 Win2000 ITBook
