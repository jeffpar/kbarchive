...
## Q207799: IBM PS/1 Will Not Boot on or After January 1, 2000
	...
	Version(s): winnt:4.0
	Operating System(s): 
	Keyword(s): kbhw kbYear2000 kbWinNT400sp4fix kbHardwarekbbuglist
	...
	When you attempt to boot an International Business Machines (IBM) PS/1 computer
	with the system date set to January 1, 2000 (or later), the computer will not
	start.
	...
	Additional query words: y2k 2000
	
	======================================================================
	Keywords          : kbhw kbYear2000 kbWinNT400sp4fix kbHardware kbbuglist
