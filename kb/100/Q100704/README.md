...
## Q100704: SMTP: Err Msg: SMTP_recv:protocol error
	...
	Send the message again. If the error occurs frequently, check the network with a
	protocol analyzer to determine the exact problem.
