...
## Q122182: CALC.EXE Display Error in Floating Point Number Calculation
	...
	kbtool kbbug3.10 kbfix3.50.sp1
	...
	The Windows NT Calculator application (CALC.EXE) has a display error in its
	floating point number calculation.
	
	NOTE: This display error is not related to the Pentium processor floating point
	division hardware.
	
	RESOLUTION
	==========
	
	Microsoft has updated CALC.EXE to resolve this problem. The new Calculator
	application works on all Microsoft Windows NT versions and on all hardware
