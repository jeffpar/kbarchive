...
{% raw %}
	...
	When you attempt to view an attachment in version 3.0 of Microsoft Mail for
	...
	To associate the attached file with the originating application, use the
	...
	1. From the File Manager File menu, choose Associate.
