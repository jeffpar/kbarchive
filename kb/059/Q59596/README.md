...
## Q59596: Mac AL: AppleLink Gateway Makes One Phone Call to AppleLink
	...
	The AppleLink Comm program connects with AppleLink to upload and download mail
	for the AppleLink gateway. When the AppleLink Comm program connects with
	AppleLink, it makes one phone call to upload and download mail messages for all
	gateway accounts while connected. Additional phone calls to reestablish contact
	with AppleLink may be required if the connection is broken because of static or
