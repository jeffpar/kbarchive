...
## Q279173: Normal and Bold TrueType Fonts Look Alike on Monitor or Printer
	...
	Normal and bold TrueType fonts in your text may look alike on your monitor or
	printer.
	
	CAUSE
	=====
	
	This behavior occurs because of an algorithm in Windows NT 4.0 that calculates
	normal and bold TrueType fonts. For conventional TrueType font compatibility,
	Windows 2000 uses the same algorithm.
