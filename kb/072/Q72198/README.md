...
{% raw %}
	...
	The following are the directories of the Microsoft MS-DOS 5 720K disks (3.5
	inch):
	
	Volume in drive B is DISK      1
	Volume Serial Number is 4005-350E
	Directory of B:\ 
	...
	XCOPY    EX_     11868 04-09-91   5:00a
	      33 file(s)     558083 bytes
	                      81920 bytes free
	
	Volume in drive B is DISK      2
	Volume Serial Number is 4A19-350E
	Directory of B:\ 
	...
	PACKING  LST      2381 04-09-91   5:00a
	...
	QBASIC   EX_    213223 04-09-91   5:00a
	      31 file(s)     701473 bytes
	                      11264 bytes free
	
	Volume in drive B is DISK      3
	Volume Serial Number is 4E29-350E
	Directory of B:\ 
	...
	The above listings are the contents of the Microsoft MS-DOS 5 packaged product
	as sent to computer manufacturers (original equipment manufacturers, or OEMs).
	This list does not necessarily apply to OEM versions of MS-DOS 5.00 if OEMs
	choose to alter it in any way.
