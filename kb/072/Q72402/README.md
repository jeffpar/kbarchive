...
{% raw %}
	...
	In File Manager, if you click and drag files from one directory to a directory
	...
	If you want to copy files or directories from one location to another on the
