...
{% raw %}
	...
	The following table is a list of external MS-DOS commands and the extension for
	the respective version number. Version numbers containing an "x" indicate all
	versions pertaining to that category.
	...
	Command                      Version
	         ...
	         2.0x  2.1x  3.00  3.2x  3.3x  4.0x  5.0   6.0   6.2   6.21
	                     3.1x                    5.00a             6.22
	
	---------------------------------------------------------------------
	APPEND    N/A   N/A   N/A   N/A   EXE   EXE   EXE   EXE   EXE   EXE
	...
	EXPAND    N/A   N/A   N/A   N/A   N/A   N/A   EXE   EXE   EXE   EXE
	...
	* Indicates the version of MS-DOS provided MSD.EXE and MSD.COM. For more
	information on these versions, query on the following words in the Microsoft
	Knowledge Base:
	
	  ms-dos and 6.20 and msd and exe and com 67h
	
	Additional query words: 6.22 2.00 2.01 2.10 2.11 3.20 3.21 3.30 3.30a 4.00 4.01 4.01a 5.00 5.00a 6.00 6.20
