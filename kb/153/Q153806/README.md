...
## Q153806: MSN Accounts and Billing Questions &amp; Answers
	...
	to change it, you can use one of the options listed below to get help.
	
	Before using one of these options, please make sure you have a pen and the credit
	card to which your MSN account is billed (to verify your account information).
	If you do not have your credit card, call MSN Member Support at the number
	listed below that is nearest you.
	
	To get a list of rules for creating your password, go to Are There Any Rules for
	Member IDs or Passwords?
	
	- In the Member Services area of MSN, click Your Account, then click Change
	  Password, and then fill in the current and new passwords on the screen that
	  appears.
	
	- Call the MSN automated password reset number. Dial one of the numbers listed
	  below and follow the step-by-step process for changing your password quickly
	  and easily over the phone. (Note: These numbers will work if you have only
	  one MSN account associated with the credit card number you enter.)
	
	   - (1) (800) 952-1110 (Canada - English/French)
	
	   - (81) (03) 5977-0196 (Japan, Tokyo)
	
	   - (81) (06) 6535-0196 (Japan, Osaka)
	
	   - (44) (0870) 601-1000 (United Kingdom)
	
	   - (1) (800) 386-5550 (United States)
	
	  If you do not live in one of the countries listed above, go to How Can I
	  Contact MSN Member Support to get help in changing your password.
	
	Are member IDs and passwords case sensitive?
	--------------------------------------------
	
	No, member IDs and passwords are not case sensitive.
	
	What areas on MSN are free of connection charges?
	-------------------------------------------------
	
	If you are using MSN Internet Access as your Internet Service Provider, then
	regular connection charges apply whenever you are connected to the Internet.
	
	NOTE: Charges vary per plan type.
	
	How can I print a copy of my billing statement?
	-----------------------------------------------
	
	To print a copy of your billing statement, follow the appropriate steps for your
	version of MSN.
	
	Using Internet Explorer
	
	1. Open your billing statement.
	
	2. Click File on your Internet Explorer toolbar, and then click Print.
	
	3. Click OK.
	
	Using the Program Viewer
	
	1. Open your billing statement.
	
	2. Reveal the Internet Toolbar by clicking the upside down triangle in the upper
	  left hand corner of the MSN Program Viewer.
	
	3. Click the printer icon on the toolbar.
	
	4. Follow the steps for printing a document.
	
	To view an online copy of your statement go to Your Account and click Online
	Statement. Then Click the printer icon on the toolbar.
	
	What do the various terms on the billing history mean?
	------------------------------------------------------
	
	Here are the definitions of some terms that you may see on your Online billing
	history:
