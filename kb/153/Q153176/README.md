...
## Q153176: SMS: Invos2.exe Incorrectly Identifies a Pentium Processor
	...
	The SMS inventory agent, Invos2.exe, will report the processor type as a 486DX
	when inventory is collected from an OS/2 client workstation with a Pentium
	processor.
	...
	Additional query words: prodsms os/2 pentium inventory
