...
{% raw %}
	...
	When Remote File Transfer is initiated and no network drives are connected to
	the SMS server, the last drive does not appear as a local drive. The last drive
	should appear for file transfer with or without a network connection to other
	drives.
