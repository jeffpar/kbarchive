...
## Q164877: SMS: PCMSVC32 Doesn't Send Status MIF After Running Job
	...
	Some jobs run by the Package Command Manager (PCM) service do not return a
	Status MIF. This results in the job never showing a status of complete in the
	Systems Management Server Administrator Jobs window.
