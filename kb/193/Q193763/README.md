...
## Q193763: GetFileAttributes API May Return Invalid Return Code
	...
	failure, and for success the value of the files attributes. Sometimes, when the
	API should have been returning failure, it was succeeding and returning invalid
	attributes.
	...
	without checking to see if it had the proper rights to obtain that information.
