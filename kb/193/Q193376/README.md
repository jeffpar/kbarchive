...
{% raw %}
	...
	The simulated Real Time Clock (RTC) will always present the century byte
	representing 19 instead of 20 in the 21st Century. This causes MS-DOS-based
	programs that access the Real Time Clock to receive the wrong date. For example,
	the year 2000 is interpreted as the year 1900.
