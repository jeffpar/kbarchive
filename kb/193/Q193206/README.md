...
## Q193206: Acquiring SNMP Info For OSPF in RRAS Hangs
	...
	On a Windows NT Server running Routing and Remote Access server (RRAS), an
	application tries to get SNMP information on OSPF and it quits responding or
	fails to obtain the information.
	...
	Additional query words: Bay Networks steelhead router wfSysObjectId walk root
