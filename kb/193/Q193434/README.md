...
{% raw %}
	...
	Novell NetWare accounts with an expiration date January 1, 2000, or later are
	migrated to Windows NT with the incorrect expiration date.
	...
	later:
	  ...
	  -------------------------------------------------------------
	  09/21/98  07:34p               198,208 Nwconv.exe    (x86)
	  09/21/98  07:34p               319,248 Nwconv.exe    (Alpha)
	...
	Additional query words: nwconvert moveit Migration Tool for NetWare 4.00
