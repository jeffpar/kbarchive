...
## Q193530: Access Violation in WINSCL When Using CR or SDB Parameter
	...
	When you attempt to use the WINSCL tool to perform maintenance on a WINS
	database, you may receive an access violation error and generate a Dr. Watson
	log when using the CR (Count Records) or SDB (Search Database) parameters.
	...
	Additional query words: wins winscl
	======================================================================
