...
{% raw %}
	...
	Japanese version(s) of Windows NT and Microsoft Access.
	
	SYMPTOMS
	========
	
	When you are printing a document created with Microsoft Access 2.0 or Microsoft
	Access 97, the spaces between characters on the printed page may be narrower
	than when you print with earlier versions of Windows NT 4.0.
