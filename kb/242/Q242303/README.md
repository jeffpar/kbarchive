...
## Q242303: NDIS Driver May Not Properly Release Network Adapter's Resources
	...
	The NDIS driver may not properly release a network adapter's resources if the
	network adapter is removed while the computer is running.
	...
	Additional query words: hot swappable
