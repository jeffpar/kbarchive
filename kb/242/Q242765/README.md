...
{% raw %}
	...
	When you quit Age of Empires II: The Age of Kings, your computer may stop
	responding (hang).
	...
	- A Sierra Screaming 3D video adapter is installed in your computer.
	
	- The Screaming 3D video driver installed on your computer is outdated.
	
	RESOLUTION
	==========
	
	To resolve this issue, download and install the latest version of the video
	driver for your video adapter from the following Sierra Web site:
	...
	Additional query words: 2.00 aoe2 aok crash freeze lockup
