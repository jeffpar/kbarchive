...
## Q166604: XFOR: IMS Behind Firewall Does Not Use Second MX Record
	...
	When you use an Internet firewall, Microsoft Exchange Server versions 4.0 and
	5.0 will sometimes fail to use a second MX record if the first is unavailable.
