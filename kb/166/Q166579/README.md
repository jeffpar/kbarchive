...
## Q166579: XCLN: Remote Connection Interval Not Constant
	...
	You may experience inconsistent connection intervals when you configure your
	Exchange Client in remote mode with the following options:
	
	- A scheduled connection time every X minutes
	
	- No dialup but "use existing network connection"
	
	The X minutes interval is not consistently effective.
	
	STATUS
	======
	
	Microsoft has confirmed this to be a problem in Microsoft Exchange Windows
	clients, version 5.0. This problem has been corrected in the latest U.S. Service
