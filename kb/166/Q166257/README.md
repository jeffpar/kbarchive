...
{% raw %}
	...
	A multi-threaded or multi-windowed application that uses OpenGL may cause an
	access violation in the Opengl.dll library.
	...
	Additional query words: drwatson c0000005 prodnt
