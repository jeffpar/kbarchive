...
{% raw %}
	...
	When you try to view permissions on a folder or file when the computer is unable
	to successfully resolve the Security Identifier (SID) to a name, the Security
	tab displays an "Unable to display security information" status. This behavior
	may occur after installing Security Configuration Manager (SCM) on Windows NT
	4.0 Service Pack 4.
