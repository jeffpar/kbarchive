...
{% raw %}
	...
	Some Routing and Remote Access Services (RRAS) ports become unavailable when a
	RAS client disconnects from a RAS connection, and cause an Event ID 20073
	message.
	...
	handler is not called and the port is not reinitialized. The port then becomes
	unavailable.
