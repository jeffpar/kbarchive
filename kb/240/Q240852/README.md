...
## Q240852: WD97: IPF When You Click ActiveX Control in Protected Document
	...
	When you double-click an ActiveX control--for example, a text box control--in a
	Word document that is protected for comments, you receive an error message
	...
	For more information about activeX controls, click the Office Assistant, type
	"activeX controls" (without the quotation marks), click Search, and then click
	to view "Insert form fields or activeX controls in a form."
	...
	Additional query words: wd97 pagefault ocx activex control toolbox protected comments
