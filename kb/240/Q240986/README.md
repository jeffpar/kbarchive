...
## Q240986: Pandora's Box: Game Graphics Are Distorted When You Use ALT+TAB
	...
	If you press ALT+TAB to switch to another program while you are playing
	Microsoft Pandora's Box, graphics in the game may be distorted when you switch
	back to Pandora's Box.
	
	CAUSE
	=====
	
	This behavior can occur if a Creative Labs Graphics Blaster Exxtreme video
	adapter is installed on your computer.
	
	RESOLUTION
	==========
	
	To resolve this issue, download and install the latest version of the video
	driver for the Graphics Blaster Exxtreme video adapter from the following
	...
	Additional query words: 1.00 msgame panbox task switching
