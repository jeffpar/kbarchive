...
## Q68070: Not Enough Core Message in PWB Caused By Lack of Memory
	...
	When loading the Programmer's WorkBench (PWB) version 1.0 or 1.1, a
	message box may appear on the screen containing the message "Cannot
	Autoload Extension, not enough core." The extension file that could
	not be loaded will be indicated. You need to free more memory so that
	the extensions can be loaded.
