...
{% raw %}
	...
	Finding a binding handle in an RPC program is accomplished through the
	RpcNsBindingLookup or RpcNsBindingImport function sets. If you use these
	function sets in a mixed Windows NT version 3.51 and 4.0 domain, you may observe
	duplicate or missing binding handles being returned by the call.
	
	CAUSE
	=====
	
	This problem occurs because the locator cache is not flushing dormant cache
	entries.
