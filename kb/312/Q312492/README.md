...
## Q312492: Dutch and Polish Versions of the SRP Truncate the Country List
	...
	After you install the Post-Windows NT 4.0 SP6a Security Rollup Package (SRP) on
	a computer that runs a Dutch or Polish version of Windows, the list of countries
	that you can select for dialing is truncated.
	...
	- Dutch:
	  ...
	  DownloadDownload the Dutch version of the fix now
	  (http://www.microsoft.com/downloads/release.asp?ReleaseID=34538)
	
	- Polish:
	
	  DownloadDownload the Polish version of the fix now
	  (http://www.microsoft.com/downloads/release.asp?ReleaseID=34539)
	
	NOTE: Install the SRP before you install these fixes.
	...
	later:
	  ...
	  --------------------------------------------------
	  05-Jul-2001  02:04  150,800  Tapisrv.exe  i386
	...
	Technology        : kbWinNTsearch kbWinNTWsearch kbWinNTW400search kbWinNT400search kbWinNTSsearch kbWinNTSEntSearch kbWinNTS400sp6 kbWinNTS400search kbWinNTS400 kbWinNTSEnt400SP6a kbWinNTW400SP6a
