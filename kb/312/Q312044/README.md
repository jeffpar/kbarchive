...
## Q312044: Access Violation in Dns.exe Causes the DNS Service to Stop
	...
	A Windows NT 4.0-based DNS server may experience frequent access violation error
	messages, and this may cause the DNS service to stop.
	...
	later:
	  ...
	  ---------------------------------------------------
	  14-Dec-2001  16:15  178,960  Dns.exe       Intel
