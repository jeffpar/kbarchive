...
{% raw %}
	...
	Version(s): 6.0
	Operating System(s): 
	Keyword(s): kbList kbVBp kbVBp600 kbGrpDSVB kbDSupportkbfixlist
	...
	6.0. This is not a comprehensive list and is current as of August 7, 1998. For
	more information about each issue, query in the Microsoft Knowledge Base on the
	article identifier (ID).
	
	For a more current fix list, go to the Support Highlights for Visual Basic at the
	following location:
	...
	Summary List for Visual Basic for Windows Version 6.0
	-----------------------------------------------------
	...
	ID         Article Title
	----------------------------------------------------------------------------
	Q142469    FIX: DBCombo Dropdown List Detaches While Dragging Parent Form
	Q142826    FIX: DBGrid Does Not Paint Correctly When Aligned
	Q142827    FIX: DBList Flashes Continuously with SSPanel
	Q142831    FIX: DBList Shrinks When Toggling Appearance Property
	Q142835    FIX: DBCombo Issues Click Event While Scrolling
	...
	Q154817    FIX: RDC Refresh Method Failure with Bound DBListbox
	
	Q159410    FIX: "Invalid Procedure Call" Referencing Collection Item
	Q161305    FIX: "Hash Marks" on ActiveX Controls After Run-Time Error
	Q168797    FIX: ImageList Control Does Not Accept Small Icons
	Q168850    FIX: MDIChild Form Not Brought to Front with Show Method
	Q169445    FIX: VisData Returns Incorrect Number of Records
	
	Q170341    FIX: LoadPicture Displays 16 x 16 Icons as 32 x 32
	Q170381    FIX: Table Name Can't Include "Call" in Parameterized SQL
	Q171952    FIX: MSFlexGrid Does Not Return All Rows with UseODBC Data
	               Control
	...
	Q172111    FIX: Visual Basic 5.0 Focus Is Not Returned to a MDI Form After 
	               a Dialog Is Shown
	...
	Q176873    FIX: DBCombo Does Not Display the "&" Character Correctly
	...
	Q178527    FIX: VB5 SP2 and SP3 Give Incorrect Floating Point Results
	...
	Q180198    FIX: RDO Does Not Work with Schema and Oracle Stored Procedures
	Q180645    FIX: Cannot Change Page Settings During Print Job
	Q180747    FIX: Focus Does Not Return to an MDI Parent Form
	Q180927    FIX: Format Function Returns Incorrect Date or Number
	...
	Q173638    FIX: "What's This?" Button Disappears from MDI Child Forms
	Q173650    FIX: Version Number Not Incrementing Using Command Line /Make
	Q173943    FIX: TreeView ToolTips Do Not Appear on Windows NT
	...
	Q176258    FIX: Refresh Method of Data Control Resets QueryTimeout
	Q194414    FIX: "Unexpected Error" Message When Loading a GIF
	
	Additional query words:
	
	======================================================================
	Keywords          : kbList kbVBp kbVBp600 kbGrpDSVB kbDSupport kbfixlist
