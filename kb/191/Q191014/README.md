...
{% raw %}
	...
	Service packs are the means by which Exchange Server 5.5 bug fixes are
	distributed. Service packs keep the product current. Service packs include
	updates, system administration tools, drivers, and additional components. All
	are conveniently bundled for easy downloading. Service packs are cumulative;
	each new service pack contains all the fixes that are in previous service packs,
	as well as any new fixes. You do not need to install a previous service pack
	before you install the latest one.
	...
	SP4 is available at the following Microsoft Web site:
	...
	SP3 is available at the following Microsoft Web site:
	
	  http://www.microsoft.com/exchange/downloads/55/sp3.asp
	...
	SP2 is available at the following Microsoft FTP site:
	...
	SP1 is available at the following Microsoft FTP site:
	...
	Additional query words: servpack bug fix download center DC get sp order CD
