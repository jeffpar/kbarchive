...
## Q191832: Access Violation in Hangul Version of Lotus Organizer 97
	...
	When you start the Hangul version of Lotus Organizer 97 on a computer running
	the Korean version of Windows NT, the following error message may occur:
	
	  Dr. Watson:
	  Access violation (0xc0000005), Address 0x77e53f76
	...
	Additional query words: codepage code page ansi string unicode av kor localize localized international smallbiz
