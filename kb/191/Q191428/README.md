...
{% raw %}
	...
	A Windows NT Server computer running WINS may fail to replicate WINS information
	to all partners if WINS is configured to replicate to more than 30 partners.
	...
	Additional query words: primary entry entries records NetBIOS name
