...
{% raw %}
	...
	The Microsoft Windows operating system version 3.1 Setup program doesn't find
	DESIGNER.EXE, DRAW.EXE, or CHARISMA.EXE when searching for applications on the
	hard drive.
