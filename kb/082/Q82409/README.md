...
{% raw %}
	...
	Printing to the AGFA Compugraphics Genics from Microsoft Windows causes the
	printer to reset in middle of printing.
	
	CAUSE
	=====
	
	This is caused by a problem in the HPPCL driver.
	...
	Additional query words: 3.10 3rdparty 3.11 win31
