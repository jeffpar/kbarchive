...
{% raw %}
	...
	The Exchange Server Information Store service may stop unexpectedly or may
	generate a Dr. Watson access violation when the information store tries to
	decode an input buffer according to the UTF7 scheme.
	...
	Additional query words: crash watson
