---
layout: page
title: "Q83063: README.WRI from Windows 3.1"
permalink: kb/083/Q83063/
---
...
## Q83063: README.WRI from Windows 3.1
	...
	3.10 3.11
	WINDOWS
	kbref kbdisplay kbsound kb3rdparty
	...
	managers with Windows version 3.1.
	...
	using this range for upper memory blocks:
	  ...
	  manager. For more information, see the README.WRI file. Type WIN /S
	  to start Windows in standard mode and choose the Read Me icon."
	...
	option instead. For more information about this and other options, see
	your 386MAX documentation.
	...
	4. Choose the Power icon to configure power-management settings. For
	  more information about the settings, press F1 or choose the Help
	...
	see Chapter 5, "Control Panel," in the "Microsoft Windows User's
	Guide."
	...
	using the Save Info button in the Program dialog box to save disctitle
	and track-title information. If you want to modify this information,
	you must do so manually by editing the MUSICBOX.INI file. To add a new
	disc to the file, you can determine the disc ID number by viewing the
	information in the About dialog box.
	...
	application in the background, increase the Background Priority option
	...
	4. Select the type of display adapter you want to use, and then choose
	  ...
	  Windows Setup copies all necessary files from the driver disk, and
	  may request files from the Windows version 3.1 disks.
	...
	copy it from Windows Disk 1 back into your Windows SYSTEM directory.
	...
	files are included on the Windows version 3.1 disks.
	...
	1. Copy and expand the VDDVGA30.386 file from the Windows 3.1 disk to
	  your Windows 3.1 SYSTEM directory.
	...
	1. Copy and expand the VGA30.3GR file from the Windows 3.1 disk to
	  your Windows 3.1 SYSTEM directory.
	...
	If you are using a Texas Instruments Graphics Architecture (TIGA)based
	display adapter, make sure that you are using a TIGA display driver
	that is provided by Windows version 3.1. Windows provides two versions
	of the TIGA display driver, "TIGA (Small fonts)" and "TIGA (Large
	fonts)."
	...
	2. Copy the SETUP.INF file on Windows Disk 1 to your Windows SYSTEM
	  directory.
	...
	For more information about modifying your CONFIG.SYS file, see your MS-
	DOS documentation. For more information about installing the EMM386
	...
	4, "Troubleshooting," in Getting Started with Microsoft Windows.
	...
	kilobytes that you want to reserve by using the /INT15= option. For
	...
	Additional query words: 3.10 kbmm winext 3rdparty wrk
