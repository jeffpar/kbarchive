...
{% raw %}
	...
	Version(s): 4.0 SP6a
	Operating System(s): 
	Keyword(s): kbenv kberrmsg kbtool kbWin2000preSP4Fix
	...
	The Dns.exe process may quit because of an access violation.
	...
	later:
	  ...
	  -----------------------------------------------------
	  01-Nov-2001  17:59  4.0.1381.7102  178,960  Dns.exe
	...
	======================================================================
	Keywords          : kbenv kberrmsg kbtool kbWin2000preSP4Fix 
