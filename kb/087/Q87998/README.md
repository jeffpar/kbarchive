...
## Q87998: Cannot Print Lists of Merge Rules, File Types, Groups, etc.
	...
	There is currently no method in WinLogin 1.0 to print lists of merge rules, file
	types, users, groups, workstations, or .INI files that are being controlled.
	...
	Additional query words: 1.00 1.0 3.10 3.11 3.1 LAN Manager LanMan remove novell network share winlog
