...
## Q149971: Network in Workstation Properties Displays Multiple Rows
	...
	When you're using the SMS Administrator, and you click on "Network" in
	"Workstation Properties," multiple rows are displayed for the current record.
	There should only be one row for the current record.
