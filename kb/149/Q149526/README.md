...
## Q149526: &quot;Access Denied&quot; When Using DIR Command on a NetWare Server
	...
	You may receive an "Access Denied" error when you use the AT command to list the
	directory contents of a mapped drive on a Novell server.
	
	CAUSE
	=====
	
	The schedule service is not passing authentication information to the NetWare
	server.
