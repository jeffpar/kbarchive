...
{% raw %}
	...
	The CTRL+BREAK key combination doesn't work as expected for any 16-bit
	application running in a Virtual DOS Machine(VDM). This problem only occurs with
	Windows NT 3.51.
	...
	Additional query words: sprodnt WOW DOS
