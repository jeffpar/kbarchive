...
## Q149188: XCLN: MSN Sign-on Dialog Appears Behind Address List
	...
	When you use multiple service providers such as Microsoft Exchange Server and
	Microsoft Network Service providers, the MSN sign in dialog might appear behind
	the drop down address list.
	
	STATUS
	======
	
	Microsoft has confirmed this to be a problem in version 4.0 of the Microsoft
	Exchange Windows 95 Client. We are researching this problem and will post new
