...
{% raw %}
	...
	When a Microsoft Exchange message is dragged to the Windows 95 desktop and later
	copied from the desktop, it can't be pasted as a link to a newly composed
	message.
