...
{% raw %}
	...
	This article contains a list of modems that have been tested and certified by
	Microsoft to be compatible with Windows for Workgroups 3.11 when using the
	Remote Access Services. Microsoft will add additional information to this
	article as it becomes available.
	
	NOTE: This list is independent of the Microsoft At Work PC Fax supported modems
	list.
	...
	Megahertz C5144 for CompaqLTE
	Megahertz XJack PCMCIA
	MicroCom QX 4232bis
	MicroComQX 4232HS
	MicroGate MG96
	MicroGate MG144
	...
	Octocom 8396
	PDI-1000
	Practical Peripherals 2400 Pkt
	...
	Elsa MicroLink 14400 Int- GER
	Hayes Optima 9600 - GER
	Hayes Optima 14400 - GER
	Hayes Ultra 9600 - GER
	Hayes Ultra 14400 - GER
	KORTEX KXPRO 9600 - FRN
	KORTEX KXPRO  2400 - FRN
	ARN DX - FRN
	NOVA FAX NFX14400 - FRN
	...
	3X 396D - FRN
	3X 514D - FRN
	KORTEX KXPRO 14400 - FRN
	KORTEX KXPOCKET 9600 - FRN
	COM1 MV215 - FRN
	COM1 MV219 - FRN
	COM1 MV216 - FRN
	COM1 MC215 - FRN
	...
	Additional query words: 3.11 unsupported incompatible works won't work HCL
