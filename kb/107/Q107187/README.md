...
{% raw %}
	...
	When you have installed U.S. Service Pack 2b and are using OzCIS to download
	data from CompuServe, data starts downloading, but then stops. The timer keeps
	running.
