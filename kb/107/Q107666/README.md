...
## Q107666: SP2b NTDETECT Doesn't Recognize Submodel Bytes of IBM Thinkpad
	...
	When U.S. Service Pack 2b for Windows NT and Windows NT Advanced Server version
	3.1 is installed on an IBM Thinkpad 755 or 360, you cannot write to a floppy
	disk.
	
	CAUSE
	=====
	
	NTDETECT that shipped with Service Pack 2b does not recognize submodel bytes on
	the IBM Thinkpad 755 or 360.
