...
## Q241752: Terminal Server Cannot Load 106-Key Japanese Keyboard Driver
	...
	When you start a Terminal Server client session and log on to a computer that is
	running the United States version of Terminal Server with the 106-key Japanese
	keyboard installed, the 101-key keyboard driver is loaded instead. This causes
	problems when you are trying to type the proper keystrokes.
