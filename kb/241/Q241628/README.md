...
## Q241628: WD97: Using Selection.Cells in a Loop Gives Incorrect Results
	...
	Programmatically setting or referencing Selection.Cells properties for cells in
	a Word table gives incorrect results when executed within a loop. For example,
	the foreground pattern color changes for only three out of four selected cells.
	...
	Additional query words: wd97 vba selection cells loop incorrect word97 qfe
