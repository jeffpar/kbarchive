...
{% raw %}
	...
	When you are running the Local Service Activity of the Northeast Corridor Route
	in Microsoft Train Simulator, the screen may appear to flicker in the display.
