...
## Q189462: Only Partial Pages Displayed or Error &quot;The Connection Was Reset&quot;
	...
	Clients connecting to a computer running Internet Information Server (IIS) 3.0
	over a slow or unresponsive network may see either of the following problems:
	
	- They receive the error message "The connection was reset".
	
	  -or-
	
	- Only partial pages are seen when opening an IIS Web page.
