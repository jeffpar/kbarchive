...
{% raw %}
	...
	After opening the document in Word 97, reapply the dot or dash border. To do
	...
	For more information about floating and inline objects, please see the following
