...
## Q172991: INFO: CAB Files Distributed with Visual Basic 5.0
	...
	Microsoft provides digitally-signed cabinets (.CAB files) containing core Visual
	Basic 5.0 files for download on the Internet. To download these CAB files, type
	"http://activex.microsoft.com/controls/vb5/xxx.cab" (without the quotation
	marks) where xxx.cab is the name of the CAB file you want to download.
	
	MORE INFORMATION
	================
	
	Here are the links to the Microsoft Visual Basic 5.0 digitally-signed .CAB
	files.
