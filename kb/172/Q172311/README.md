...
{% raw %}
	...
	After you choose the left-handed mouse configuration using the Mouse tool in
	Control Panel, the mouse buttons may behave incorrectly.
	
	For example, when you double-click My Computer with the primary mouse button, the
	context menu for My Computer may open, as if you had clicked with the secondary
	mouse button.
	...
	Additional query words: single right
