...
## Q172540: Windows NT Server Tools for Windows 95 Readme.txt File
	...
	Operating System(s): 
	Keyword(s): kbreadm msnets win95
	...
	with the Windows NT 4.0 Server Tools for Windows 95.
	
	For information about obtaining the Windows NT 4.0 Server Tools for Windows 95,
	...
	7. Manually adjust the AUTOEXEC.BAT file to include C:\Srvtools in the 
	  PATH (if drive C is the boot drive). For example, if you boot from drive C, 
	...
	* To use any of the Windows NT Server Tools you must have administrative 
	...
	3. To see accounts in another domain, click Select Domain on the User 
	  menu.
	...
	1. Double-click Network Neighborhood, and then double-click the name of 
	  the computer to be administered. 
	...
	* Administering print queues through the Printers list in My Computer; 
	 these print queue objects represent print queues local to your Windows 
	 95 computer, even if the queue is redirected to a Windows NT Server or 
	...
	* For other administrative tasks, use Server Manager and User Manager, 
	 ...
	 NetWare, and NetWare-enabled users. These are the same Server Manager 
	 and User Manager options that are available on computers running Windows NT 
	 Server with File And Print Services For NetWare.
	
	Additional query words:
	
	======================================================================
	Keywords          : kbreadm msnets win95 
