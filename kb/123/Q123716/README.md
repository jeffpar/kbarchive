...
{% raw %}
	...
	When you run CACLS.EXE against a three to five gigabyte directory tree, the
	following error message appears when the process is about 50 percent complete:
	
	  NO MORE INTERNAL IDs AVAILABLE.
	...
	Additional query words: prodnt 3 5 3-5
