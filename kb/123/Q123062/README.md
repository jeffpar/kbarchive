...
## Q123062: Windows NT 3.5 Fails to Unlock a Record Area After Locking It
	...
	Under certain conditions, Windows NT version 3.5 fails to unlock a record area
	after locking it. This problem does not happen with Windows NT version 3.1.
