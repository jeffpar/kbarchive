...
## Q123822: PC Win: First Tab Prints As a Space
	...
	When you print from Microsoft Mail for Windows, the first tab character on a
	line is printed as a space.
	...
	Additional query words: 3.00 3.00b 3.20 3.20a print tab
