...
## Q123976: Sequential File Reads of 4K Instead of 64K Blocks
	...
	In Windows NT, sequential reads from a large file should be in blocks of 64K.
	Under certain circumstances, Windows NT incorrectly reads in 4K blocks (on the
	ALPHA platform it is 8K) and performance is reduced.
