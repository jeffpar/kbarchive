...
## Q84883: PC OS2: Restarting OS/2 Client Causes Trap 00D Error
	...
	Exiting version 3.0, 3.0b, or 3.2 of Microsoft Mail for PC Networks, OS/2
	workstation and immediately restarting it causes an OS/2 Trap 00D error.
	
	CAUSE
	=====
	
	Mail is restarting before it finishes closing.
