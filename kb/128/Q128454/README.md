...
## Q128454: Windows NT 3.51 Hangs with Office 95 (Word) Help File Wizard
	...
	When you run Microsoft Word for Windows 95 (from Microsoft Office for Windows
	95) on Windows NT 3.51 and open the help file wizard (Winhlp32), Windows NT
	stops responding (hangs).
	
	CAUSE
	=====
	
	Windows NT causes a memory access violation.
