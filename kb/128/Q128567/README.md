...
{% raw %}
	...
	When you print a page in landscape orientation with a PostScript driver under
	Windows NT 3.5 or 3.51, the text is in the opposite corner of where the
	landscape text is when printing with a Windows NT PCL driver. This is not
	consistent with the Windows 95, Windows, Windows for Workgroups, or the Windows
	NT 3.1 PostScript drivers.
