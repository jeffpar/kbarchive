...
{% raw %}
	...
	It has been reported that Flight Simulator version 4.00 can produce a mode that
	...
	The following assumes that the plane is currently moving forward. To create
