...
{% raw %}
	...
	For users with European regional settings, the Auto Select device setting
	property for automatically created client printers is set to Letter instead of
	A4 on raster printers.
	
	CAUSE
	=====
	
	The configuration file for raster printers is coded to use United States
	settings.
	...
	later:
	  ...
	  --------------------------------------------------
	  03/08/00  09:05p    77,584  Rasddui.dll   Intel
