---
layout: page
title: "Q225088: Services.exe Problems When You Try to View Log Files"
permalink: kb/225/Q225088/
---
...
## Q225088: Services.exe Problems When You Try to View Log Files
	...
	Operating System(s): 
	Keyword(s): kbenv kberrmsg kbtool kbui kbWinNT400sp5fix
	...
	When you try to view logs associated with the Windows NT 4.0 Event Viewer
	program, Services.exe may stop responding (hang) or it may generate an access
	...
	======================================================================
	Keywords          : kbenv kberrmsg kbtool kbui kbWinNT400sp5fix 
