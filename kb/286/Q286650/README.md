...
{% raw %}
	...
	After you apply Exchange Server 5.5 Service Pack 4 (SP4), any newly created
	public folders or distribution lists that do not have a given name, initial, and
	surname cannot properly generate the comparative portion of the Lotus Notes
	address, for example:
