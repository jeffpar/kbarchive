...
## Q276338: Classic Board Games: Computer Hangs When You Uninstall Program
	...
	When you attempt to uninstall Microsoft Classic Board Games, the computer may
	stop responding (hang).
	
	CAUSE
	=====
	
	This behavior can occur if a sound card based on the SoundMAX chip set is
	...
	Additional query words: 1.00 msgame boardgames cbg remove hangs freeze lock
