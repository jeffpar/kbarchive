...
## Q322645: Microsoft SQL Server 2000 Programming Step by Step Comments and
	...
	relating to the Microsoft Press book Microsoft SQL Server 2000 Programming Step
	by Step, ISBN 0-7356-1142-4.
	...
	To:
	"insert only the OilID, OilName, and LatinName columns. Delete the "*" row from
	the Grid Pane."
	...
	Additional query words: 0-7356-1142-4 SQL2K SBS EUBOOK BKOFFICE RIORDAN
