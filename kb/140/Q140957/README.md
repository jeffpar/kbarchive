...
{% raw %}
	...
	The Microsoft Exchange Message Transfer Agent (MTA) generates the following
	error in the Windows NT Event Viewer when it processes a message from an X.400
	gateway.
	  ...
	  Error: Exception c0000005 occurred at Address 215bde9 [BASE XFER-IN 20] (16)
