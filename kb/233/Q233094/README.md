...
## Q233094: STOP 1E Error Message in Sfmsrv.sys
	...
	When you run Services for Macintosh on a Windows NT Server-based computer, you
	may receive a STOP 1E error message in Sfmsrv.sys. The error message may contain
	the following parameters: 0xc0000005, 0xf1b28880, 0x0, 0x0.
