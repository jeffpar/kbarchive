...
{% raw %}
	...
	The following is a list of confirmed bugs in MS-DOS version 6.22. For more
	...
	Article ID  Article Title
	  ...
	  Q76242 Error Message During MS-DOS 6.x Setup Due to Invalid PATH
	  ...
	  Q97595 Getting Past the 128-Character PATH Limit
	  ...
	  Q120768 Creating Single Startup Disk with MS-DOS 6.22 Upgrade Setup /F
	
	Additional query words: 6.22 comprehensive
	
	======================================================================
	Keywords          : msdos kbbuglist
