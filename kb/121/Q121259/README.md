...
## Q121259: Comparing Features of Windows Sound System 1.0, 1.0a, and 2.0
	...
	This article lists some of the features in Microsoft Windows Sound System
	versions 1.0, 1.0a, and 2.0.
	...
	- ProofReader supports Microsoft Excel versions 3.0 and later and Lotus
	  versions 1.0, 1.0a, and 1.10.01
	...
	- Supports MS-DOS-based games in full-screen mode. The Windows Sound System
	  drivers are located in the Drivers area of Control Panel.
	
	- WSSXLAT requires EMM386.EXE version 4.47 or later. No other memory managers
	  are supported.
