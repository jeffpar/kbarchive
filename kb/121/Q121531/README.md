...
## Q121531: Windows NT Separator Pages May Print an Incorrect Date
	...
	The Windows NT Separator Page may incorrectly add a day to the system date on
	the printed page. For example, if it is 10:00 PM EST on October 7, 1994, the
	Separator page may be dated 10-8-94. The time when one day is added varies
	...
	version 3.5. This problem was corrected in Windows NT Workstation or Server
	version 4.0.
