...
## Q182653: Component Builder Title Bar Shows MS-DOS Filename
	...
	When a COMTI typelib, in a folder that has a long name, is opened in the
	Component Builder, the MS-DOS path is shown on the title bar instead of the path
	of the long file name.
	
	WORKAROUND
	==========
	
	There is nothing to work around -- just something to be aware of.
