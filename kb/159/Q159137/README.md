...
## Q159137: Moving Files Can Corrupt NTFS Partition
	...
	Under rare conditions, Ntfs.sys can cause file corruption when moving files on
	the same volume.
	
	WORKAROUND
	==========
	
	Ntfs.sys has been fixed in Windows NT 4.0 Service Pack 2 and later.
	...
	Additional query words: volume corrupt prodnt
	======================================================================
