...
{% raw %}
	...
	Windows NT 4.0 files can support only half the number of streams as previously
	available under Windows NT 3.51.
	
	WORKAROUND
	==========
	
	This problem has been fixed in the Ntfs.sys file contained in Windows NT 4.0
	...
	Additional query words: NTFS threads prodnt
	======================================================================
