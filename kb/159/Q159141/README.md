...
## Q159141: CDFS Incorrectly Creates Short File Names for Some Files
	...
	Cdfs.sys creates short file names for some files that already have valid 8.3
	unicode file names.
	
	WORKAROUND
	==========
	
	There is a fixed version of Cdfs.sys available on Windows NT 4.0 Service Pack 2
	and later.
