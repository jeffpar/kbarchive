...
{% raw %}
	...
	When you set an account to expire on February 29, 2000, User Manager displays
	...
	later:
	  ...
	  -------------------------------------------------------------
	  04/09/98  02:17p               302,848 Netui2.dll    (x86)
	  04/09/98  02:19p               492,304 Netui2.dll    (Alpha)
