...
## Q223437: NWRDR Access Violates in Module Nwslib.dll
	...
	The Nwssvc.exe service stops with the following error:
	
	  Exception for application exception occurred @obj\i386\nwssvc.exe
	
	CAUSE
	=====
	
	An access violation occurs because of an attempt to view data within a pointer
	...
	Additional query words: 4.00 FPNW NWS Netware Services File Print
