...
{% raw %}
	...
	When you play Microsoft Midtown Madness 2, your vehicle may stick in the ground
	near the San Francisco docks if you drive the vehicle beneath the archways.
	
	RESOLUTION
	==========
	
	To work around this issue, drive the vehicle very fast when you drive the
	vehicle beneath the archways near the San Francisco docks,
	...
	Additional query words: 2.00 msgame mm2 midmad stuck cannot move
