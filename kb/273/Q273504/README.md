...
## Q273504: SNMP Trap Is Not Sent Over a RAS Client Connection
	...
	A Simple Network Management Protocol (SNMP) trap is not sent over a Remote
	Access Service (RAS) client connection unless a network adapter is installed on
	the client computer.
	...
	later:
	  ...
	  ---------------------------------------------------
	  11/03/00  8:45pm  24,848  Snmpapi.dll      i386
	  11/03/00  8:43pm  43,280  Snmpapi.dll      Alpha
