...
{% raw %}
	...
	You may receive the following error message on a blue screen:
	  ...
	  STOP 0x0000000a (0xc0007000, 0x00000002, 0x00000000, 0x8012a5a1)
	  ntoskrnl.exe
	
	CAUSE
	=====
	
	The Windows NT 4.0 Netbt.sys system file is attempting to free a null pointer,
	...
	later:
	  ...
	  ----------------------------------------------
	 09/29/2000  17:05  124,688  Netbt.sys  Intel
