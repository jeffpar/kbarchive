...
## Q174877: FIX: Selecting a File in SourceSafe Explorer Causes Refresh
	...
	The file pane in the SourceSafe Explorer refreshes when a file is selected,
	causing the file pane to flicker. Typically, larger projects will take longer to
	refresh the entire file pane.
	...
	Additional query words: flash hangs
