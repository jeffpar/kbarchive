...
## Q174460: SMS: PCM Introduction Dialog Box Does Not Close Automatically
	...
	The Package Command Manager (PCM) application dialog box is displayed at every
	logon attempt. However, the dialog box does not automatically close when Package
	Command Manager is finished with its current cycle.
	...
	Additional query words: prodsms smspcm
