...
{% raw %}
	...
	Microsoft Internet Explorer has built-in security that you can use to control
	...
	To configure your Internet Explorer security settings to specify the types of
