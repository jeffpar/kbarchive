...
## Q174994: WD97: Autoexec Macro Runs Twice When Reference Is Added
	...
	In Microsoft Word 97 for Windows, if you have an Autoexec macro that contains
	code that programmatically adds a reference using VBA, the Autoexec macro will
	run twice when executed.
	...
	Additional query words: Autoexec macro twice second winword.exe
	
	======================================================================
	Keywords          : kbmacro kbdta 
