...
{% raw %}
	...
	By default, borders are not displayed for cells that do not have content. To
	...
	At run-time, borders are not displayed for empty cells. At design-time, borders
