...
{% raw %}
	...
	An SNMP service running on Windows NT will ignore any trap Protocol Data Unit
	(PDU) that is larger then 4,096 bytes.
	
	CAUSE
	=====
	
	The buffer size for the SNMP service is limited to 4 KB.
	...
	Additional query words: Mgmtapi.dll
	======================================================================
