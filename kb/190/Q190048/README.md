...
{% raw %}
	...
	When you run a DHTML application in the integrated development environment (IDE)
	and a MsgBox statement in code is carried out, the MsgBox shows up behind the
	browser.
	...
	screen, select the Visual Basic application from your taskbar to view and clear
	the message.
