...
## Q190142: FTP Deadlocks Under Heavy Load
	...
	File Transfer Protocol (FTP) may deadlock under heavy load.
	...
	For additional information about FTP deadlocking, see the following Knowledge
	Base article:
	
	  Q191822 : FTP Service May Cause Deadlock in FTP and Other IIS Services
	
	
	Additional query words: sp hot fix qfe iisftp iisgeneral
