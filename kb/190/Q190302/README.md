...
## Q190302: SMS: Remote Control Does Not Log Security to the Event Log
	...
	On Windows NT Systems Management Server clients, the Systems Management Server
	Remote Control Agent may fail to update the security event log after a remote
	control session.
