...
## Q190354: Unattended Setup of MSCS with -JOIN Parameter Requires Input
	...
	While using the -JOIN parameter to perform an unattended setup of Microsoft
	Cluster Server on the second node, a dialog box titled "Setup needs to identify
	all network resources...." appears that requires user input.
