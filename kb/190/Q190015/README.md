...
## Q190015: Setting LogonMethod to Batch Causes &quot;Parameter is Incorrect&quot;
	...
	After using ADSUTIL to set the LogonMethod to Batch, requests for a Web page
	...
	Additional query words: errmsg err Adsutil.vbs Logon Method api paremeter akz
