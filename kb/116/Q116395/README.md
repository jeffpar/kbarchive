...
{% raw %}
	...
	The following information was taken from the MS-DOS 6.22 NETWORKS.TXT file. Some
	minor changes have been made to this file since the version included with MS-DOS
	6.2 (most notably in the "IBM PC LAN Program Version 1.33 or Earlier" and
	"Novell Networks" sections).
	...
	This file contains information about making your network compatible with 
	MS-
	DOS 6.22. If you are running MS-DOS 5.0 or later, you do not need to make
	any changes to your network to make it compatible with MS-DOS 6.22.
	
	If Setup referred you to this file, see Section 1 below. If you are 
	looking
	for additional information about your network software, find the
	...
	previously upgraded to MS-DOS 5.0, your current version of the 3+Share
	...
	obtain the redirector by ordering the Supplemental disks. For more 
	information, see the coupon at the back of the MICROSOFT MS-DOS USER'S 
	GUIDE.
	...
	obtain updated network files by ordering the Supplemental disks. For more 
	information, see the coupon at the back of the MICROSOFT MS-DOS USER'S 
	GUIDE.
	...
	updated network files by ordering the Supplemental disks. For more 
	information, see the coupon at the back of
	...
	* Temporarily override the search drive by using the MAP command
	...
	The following file is available for download from the Microsoft Download Center:
	  ...
	  DownloadDownload Memman.exe now
	...
	Additional query words: msbackup defrag 6.22
