...
{% raw %}
	...
	When you paste certain characters into 16-bit applications, they become
	different characters. For example, using the English locale, if you copy the
	trademark symbol, and attempt to paste it into Word for Windows, it is pasted as
	an exclamation mark (!).
