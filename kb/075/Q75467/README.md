...
{% raw %}
	...
	The Power Nine video driver manufactured by Number Nine Computer Corporation may
	...
	For example, if the Windows 3.0 installation is started on a 3.5-inch disk, and
