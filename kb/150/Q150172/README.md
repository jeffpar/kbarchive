...
{% raw %}
	...
	If you try to create a file larger than 2.14GB on a File and Print Services for
	NetWare (FPNW) volume, using an MS-DOS/VLM NetWare client, the following error
	message appears:
