...
{% raw %}
	...
	Scholastic's The Magic School Bus Explores Inside the Earth (MSB Earth):
	...
	Earth, follow these recommendations:
	
	- Do not use Windows "Hot Keys" while running MSB Earth.
	
	- For faster performance, verify that the system has a permanent swapfile.
	
	
	Additional query words: 1.00 msbhb msbss frizz kbmm multimedia multi-media multi media msbearth geology frizzle
