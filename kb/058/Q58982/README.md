...
## Q58982: Mac AL: AppleLink Out Basket Folder Created by AppleLink Comm
	...
	When the AppleLink Comm program starts up, it checks for a folder named
	AppleLink Out Basket in the System Folder. If this folder does not exist,
	AppleLink Comm creates it. Nothing is done if it already exists.
	
	Outgoing mail messages are written in the AppleLink Out Basket folder by the
	AppleLink gateway. AppleLink Comm then connects with AppleLink to send this
	outgoing mail and to receive any incoming mail.
