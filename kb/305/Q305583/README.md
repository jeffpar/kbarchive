...
## Q305583: MechCommander 2: You Cannot Start a Multiplayer Game
	...
	*********************************************************************
	...
	When you attempt to start a multiplayer game of Microsoft MechCommander 2 from
	Zone.com, the introduction videos play, and then you are presented with only a
	single-player option screen.
	...
	NOTE: This behavior has been reported when nVIDIA GeForce2 video adapter is
	...
	Additional query words: msgame igz mc2 Zone Messenger IM lobby
