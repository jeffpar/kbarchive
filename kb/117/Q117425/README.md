...
{% raw %}
	...
	After you install an application or make changes to the Registry, the following
	error message appears:
	
	  SCREG.EXE Application Error
	  The instruction at 7701b5f13 references memory at 00540052.
