...
## Q117763: PC Gen: README.TXT: Supplementary Modem Scripts Disk
	...
	The following is the text of the README.TXT file from the Supplementary Modem
	Scripts Disk.
	
	MICROSOFT MAIL SCRIPT INSTALLATION V3.0
	---------------------------------------
	
	Welcome to the Modem Script Setup program for Microsoft Mail. SETUP installs
	Microsoft Mail Modem Script files on your hard disk or on a network by copying
	the script source and compiled files.
	...
	- Toshiba Laptop int. 2400        GETOSH34.SCR
