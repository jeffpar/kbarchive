...
{% raw %}
	...
	This article explains Remote Access Service (RAS) Event IDs as they appear in
	the Event Viewer System Log of Windows versions 3.1 and 3.5. The following list
	contains the error code (RAS EVENT ID), the symbol name, the message text, a
	brief explanation of the code, and a suggested course of action to correct the
	problem causing the error code.
	
	NOTE: RAS Event IDs begin with RAS_LOG_BASE = 20000. However, RAS Event ID codes
	specific to Windows NT version 3.5 begin with RAS_LOG_BASE = 20064.
	...
	MESSAGE TEXT: Cannot receive initial frame on port %1. The user has been
	             Disconnected.
	EXPLANATION : RAS may not be installed on client.
	...
	MESSAGE TEXT: The user connected to port %1 has been disconnected due to a
	             system error.
	EXPLANATION : A system error caused the RAS user to be disconnected.
	...
	EXPLANATION : Possible serial port problems.
	...
	EXPLANATION : Possible duplicate name on LANA %1.
	...
	EXPLANATION : Possible hardware problem.
	...
	EXPLANATION : RAS was not installed properly.
	...
	EXPLANATION : Since the memory cannot be allocated, RAS cannot be used.
	USER ACTION : Check configuration of RAS with the Control Panel Network
	             tool. Reinstall RAS if needed.
	...
	EXPLANATION : Illegal entry in the registry for the parameter given.
	...
	EXPLANATION : The caller has taken too long to authenticate.
	...
	EXPLANATION : RAS Connection Manager is configured incorrectly.
	...
	EXPLANATION : Possible hardware of configuration problem.
	...
	MESSAGE TEXT: Internal Error: Disconnect operation on %1 completed with an
	             error.
	EXPLANATION : Disconnected from remote user with an error.
	...
	EXPLANATION : The user password has expired.
	...
	EXPLANATION : The user account does not have Remote Access privileges.
	USER ACTION : Contact the administrator.
	...
	EXPLANATION : The RAS server is unable to communicate through TCP/IP.
	...
	EXPLANATION : The RAS Server has an IP address for its NDISWan connection.
	USER ACTION : None.
	...
	EXPLANATION : The RAS Server was unable to complete a callback
	...
	MESSAGE TEXT: Cannot receive initial data on port %1. The user has been
	             disconnected.
	EXPLANATION : Possible bad phone lines or bad modem.
	USER ACTION :
	...
	EXPLANATION : The RAS server ran out of per server licenses.
	...
	Additional query words: ppplog ntfaqipr
	======================================================================
	Keywords          : kbnetwork 
