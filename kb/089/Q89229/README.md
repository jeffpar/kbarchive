...
## Q89229: Programs to Create or Modify Icons for Windows
	...
	The following is a list of some of the software packages that can be used to
	create or modify icons for Windows. The products included here are manufactured
	...
	Additional query words: 3.00 3.00a 3.10 3.11 isv 3rdparty
