...
{% raw %}
	...
	If you try to use Media Player to play CD audio and the compact disc you are
	...
	To work around this problem, you may be able to drag the thumb tab in Media
