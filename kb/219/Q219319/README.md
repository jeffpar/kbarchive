...
## Q219319: STOP in Winlogon.exe When Printing and Running Screen Saver
	...
	While printing large files and the screen saver is activated automatically, you
	may receive the following blue screen error message:
	
	  STOP 0xc000021a in WINLOGON.EXE
