...
## Q219354: RCP Does Not Work on SP4 with a Permission Denied Error
	...
	When you use the RCP command to copy files between a UNIX computer and a
	computer running Windows NT 4.0 Service Pack 4, the command does not work and a
	"Permission Denied" or "Not found" error message may be displayed. If you use
	the same command on a computer running Windows NT Service Pack 3, it performs as
	expected.
