...
## Q219299: Hotfix Data Written After Unsuccessful Non-Cached Read
	...
	When a non-cached read request is unsuccessful on an NTFS partition that uses
	Windows NT disk-mirroring, the Windows NT fault tolerant disk driver may write
	hotfix data (0xFF) to the partition.
