...
## Q219309: SP5ss:Clussvc: SetErrorMode is not set and we sit behind pop-ups
	...
	When you run the Cluster service on a computer running Microsoft Windows NT
	Server 4.0, a pop-up error message similar to the following may be displayed:
	
	  Clussvc: Corrupt file or Disk.
	
	When this error message appears, both nodes in the cluster may stop responding
	(hang).
