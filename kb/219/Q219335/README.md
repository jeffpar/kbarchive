...
## Q219335: SNMP Application Error After Installation on Exchange Server
	...
	After you install the Microsoft Simple Network Management Protocol (SNMP)
	service on a computer running Windows NT that already has Microsoft Exchange
	Server version 5.5 installed and then restart the computer, the following error
	message may be displayed:
	
	  Application error occurred on SNMP.exe
