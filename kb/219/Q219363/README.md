...
## Q219363: Characters Missing from Print Jobs Spanning Multiple Pages
	...
	When you use a Hewlett Packard 1600C printer to print Microsoft Excel 97
	multi-page jobs in color mode through Unidrv 5.4, you may notice characters are
	dropped, crowded over each other, re-typed, and so forth.
