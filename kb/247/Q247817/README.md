...
## Q247817: WLBS Display Command Produces Inaccurate Event Logs
	...
	When you use the "WLBS DISPLAY" command at a command prompt, the data fields
	printed out for event logs may not match the actual event log values. This
	problem does not affect normal computer operations.
