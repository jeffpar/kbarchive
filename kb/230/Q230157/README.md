...
{% raw %}
	...
	When you print a job using the letter form on an Hewlett-Packard HP 4si printer
	from a computer running Windows NT 4.0 Service Pack 4, the print margins may be
	incorrect.
	
	CAUSE
	=====
	
	This problem occurs because the printable area for this printer and for the
	letter form was changed in Windows NT 4.0 Service Pack 4.
