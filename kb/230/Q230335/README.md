...
## Q230335: Date May Be Displayed Improperly Using Configuration Back-Up
	...
	Version(s): winnt:4.0
	Operating System(s): 
	Keyword(s): kbYear2000 kbWinNT4sp6fix
	...
	When you use the Configuration Back-Up option in the HTML Administrator version
	of the Internet Server Manager program in Microsoft Internet Information Server
	(IIS) 4.0, the current date for the stored configuration may be displayed
	improperly if the configuration is stored on or after 1/1/2000.
	...
	NOTE: This software update was replaced on July 16, 1999 with an updated
	version.
