...
## Q132604: Cannot Explore Folders in NetHood Folder
	...
	If you create a folder in the Windows\NetHood folder and try to view it using
	Network Neighborhood, you see another item instead of the folder you are trying
	to view.
