...
## Q119788: Running 16-bit Applications with Long Directory Structure
	...
	structure longer than 100 characters, including the filename, from File Manager,
	the program doesn't run and no error message appears. When you attempt to run a
	16-bit Windows-based application from a command prompt, the following error
	message appears:
