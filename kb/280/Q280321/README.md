...
## Q280321: LDAP Program May Generate Access Violation Under Stress
	...
	bind and unbind operations over Secure Sockets Layer (SSL), the program may
	generate an access violation and stop working.
	...
	later:
	  ...
	  -----------------------------------------------------------------
	  11/28/00  01:05p  4.86.1964.1877  123,664  Schannel.dll  Intel
