...
## Q280756: SMS: List of Bugs Fixed in Systems Management Server 2.0 SP3
	...
	Base:
	  ...
	  Q246863 The Assignments Are Not Mandatory Over Slow Links Option Does Not
	  Work as Expected
	
	  Q248452 Remote Control Residual Permissions Override the Permission Required
	  Option
	
	  Q249121 SMS: COMMIT TRANSACTION Request Has No Corresponding BEGIN
	  TRANSACTION
	
	  Q249136 SMS: Software Inventory Agent May Cause Windows 95 Clients to Hang
	
	  Q249179 SMS: Delays in Displaying Distribution Points in SMS 2.0 Site
	
	  Q250976 SMS: Software Metering Does Not Use Original Program Name Policy in
	  Offline Mode
	
	  Q251099 SMS: Slow Performance in License Metering Administration Tool
	
	  Q253205 SMS: Long Event to Trap Translator Description Causes Error Message
	  ...
	  Q257700 SMS: Advertisements Do Not Run If Domain Controller Is Unavailable
	
	  Q258227 SMS: Apostrophe in User Name or Group Name Causes SQL Error Messages
	
	  Q258423 SMS: Preferred Sender Capability Does Not Work with Starburst Sender
	
	  Q259408 SMS: Threshold Settings for Sitestat Lost When a CAP Is Unavailable
	
	  Q259538 SMS: Eventrap Uses 100% of CPU Resources Trying to Enumerate Event
	  Sources with Long Descriptions
	
	  Q259702 SMS: Loss of Status Messages During Software Distribution
	
	  Q260366 SMS: SMS Executive Service Can Hang When Started by Site Backup
	  Service
	
	  Q262018 SMS: SMS Installer Generates Error Message When Using Oracle ODBC
	  Script Items
	
	  Q263198 SMS: Error Message: You Have Referenced the Variable DEST 9. This
	  Variable Has Not Been Previously Defined
	
	  Q263665 SMS: Site-Wide Travel Mode Switch Prevents New Clients from Being
	  Assigned
	
	  Q264378 SMS: Site System Summarizer May Deadlock
	
	  Q264493 SMS: Creating a Secondary Site from Source Files on the Local Drive
	  Does Not Work
	
	  Q264524 SMS: DDR Backlog Because DDM Does Not Delete Read-Only DDRs
	
	  Q264740 SMS: Courier Sender Creates Large Files If Package Is Sent to
	  Multiple Sites
	  ...
	  Q265882 SMS: Client Configuration Manager Does Not Append .ccr to the Client
	  Configuration Request
	
	  Q266287 SMS: Network Discovery Properties Page Appears to Hang When You
	  ...
	  Q267949 SMS: Programs Set to Run Only When a User Is Logged On May Not Run
	
	  Q268099 User and User Group Ads Do Not Work for Logged-On Users with DBCS
	  User Names That Cannot Be in Uppercase
