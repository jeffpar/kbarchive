...
## Q280071: XCON: Message Read or Unread Status Lost Migrating from cc:Mail
	...
	When you migrate a user from Lotus cc:Mail to Exchange Server 5.5, the message
	read or unread status may not be preserved on messages that contain highlighted
	text.
