...
## Q167947: FIX: ODBC CAB File Does Not Install 16-bit ODBC Files
	...
	Applications that use 16-bit ODBC drivers fail to connect.
	
	CAUSE
	=====
	
	The ODBC CAB file did not include the 16-bit ODBC driver files.
	
	RESOLUTION
	==========
	
	The CAB file has been updated to include all of the 16-bit ODBC driver files.
