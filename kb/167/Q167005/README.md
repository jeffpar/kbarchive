...
{% raw %}
	...
	When you save a form that has been developed using Microsoft Exchange Forms
	...
	Microsoft has confirmed this to be a problem in the Microsoft Exchange Client
