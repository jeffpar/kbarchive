...
{% raw %}
	...
	The Canon Bubble Jet BJC-4300 does not support ledger paper even though the
	driver indicates it is a valid paper size. The printer physically cannot feed 11
	x 17 paper.
	...
	You will no longer be presented with ledger paper size with the fixed
	Canon800.dll.
