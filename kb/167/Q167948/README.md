...
## Q167948: FIX: Internet Component Download Fails After Using Setup Toolkit
	...
	Internet component download fails and/or licensed Visual Basic 5.0 created
	controls (UserControls) fail.
	
	CAUSE
	=====
	
	The setup toolkit fails to set the default value for the main license key.
	
	RESOLUTION
	==========
	
	The setup toolkit has been updated to correctly set the default value of this
	key for both regular and Internet setups.
