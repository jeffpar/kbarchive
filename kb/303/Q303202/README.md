...
## Q303202: ASPs Are Not Being Checked for Valid Values in Windows 2000
	...
	When you gain access to an Active Server Page (ASP), the page is not checked for
	the validity of its values. This situation can cause inconsistent cross-process
	calls.
