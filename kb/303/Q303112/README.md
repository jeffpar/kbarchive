...
## Q303112: Pandora's Box: Run-Time Error When You Attempt to Start Game
	...
	When you try to start Microsoft Pandora's Box, you receive one of the following
	error messages:
	
	  Microsoft Visual C++ Runtime Library: C:\Program Files\Microsoft
	  Games\Pandora's Box\pandora.icd. Abnormal program termination
	...
	To resolve this issue, download and install the Pandora's Box Update Patch Set
	1.0 from the following Microsoft Web site:
	
	  http://www.microsoft.com/games/pandorasbox/downloads.htm
	
	NOTE: If you do not receive these error messages upon startup, there is no need
