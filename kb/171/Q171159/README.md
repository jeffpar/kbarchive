...
## Q171159: WD97: List of Fixed Problems in Word 97 for Windows, SR-1
	...
	The following table lists fixed problems in Microsoft Word 97 for Windows,
	Service Release 1. For more information about each issue, query in the Microsoft
	Knowledge Base on the article identifier (ID). For additional information about
	...
	In addition to the fixes or improvements listed above, the following problems
	were corrected in the indicated converters that ship with Microsoft Word 97
	Service Release 1.
	...
	- Hyperlinks Exported from the HTML Converter Are Imported as URL, Not with the
	  Friendly Text
	...
	For more information about the converter updates in Microsoft Word 97 Service
	Release 1, please see the following article in the Microsoft Knowledge Base:
