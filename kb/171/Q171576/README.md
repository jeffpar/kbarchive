...
{% raw %}
	...
	The RISC version of Visual Basic unexpectedly quits when AddressOf is used in
	either the IDE or when running a Pcode-compiled exe.
	...
	This problem does not occur with the Intel version of Visual Basic 5.0.
