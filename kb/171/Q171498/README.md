...
## Q171498: FIX: Screen Turns Black When Compiling
	...
	If the Console Window display option setting is set to "Full Screen," then the
	screen will go black while compiling the Visual Basic Application.
	
	RESOLUTION
	==========
	
	Install Service Pack 2 (SP2) or follow the steps below:
	
	1. Open the Control Panel.
	
	2. Double-click the Console Applet.
	
	3. Set the display option to Window.
