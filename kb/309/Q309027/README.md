...
## Q309027: Academic Learning Series Microsoft Exchange 2000 Server Implemen
	...
	- MSPRESS Academic Learning Series Microsoft Exchange 2000 Server Implementation and Administration ISBN 0-7356-1430-X 
	-------------------------------------------------------------------------------
	...
	relating to the Microsoft Press book Academic Learning Series Microsoft Exchange
	2000 Server Implementation and Administration, ISBN 0-7356-1430-X.
	...
	On page 119, please remove the first statement at the top of the page:
	
	"However, it is possible to move servers between routing groups in the same
	...
	Additional query words: ALS 0-7356-1430-X UNKROTH
