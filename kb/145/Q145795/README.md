...
{% raw %}
	...
	In Microsoft Exchange Windows clients, the "When selecting, automatically select
	entire word" option does not always work. It will not select the entire word
	when you select the last character of a word that is followed by a punctuation
	mark or hard return
