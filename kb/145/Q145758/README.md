...
{% raw %}
	...
	The following files from the PSS directory of the CD-ROM version of Visual Basic
	4.0 can be redistributed with your Visual Basic program. Redistributing these
	files with your Visual Basic program is within the terms of the End User
	Licensing Agreement.
	
	WARNING: Regclean.exe is provided "as is" without warranty of any kind. Microsoft
