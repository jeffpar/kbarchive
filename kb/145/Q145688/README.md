...
{% raw %}
	...
	---------------------
	This folder contains a series of "PowerToys"-- UI enhancements for advanced
	...
	*** FIND X
	...
	--------------------------
	1.Open the control panel: On the Start Menu, choose Settings->Control
	Panel.
	...
	-------------------------
	PREVIOUS CHANGES/PROBLEM FIXES:
	-------------------------
