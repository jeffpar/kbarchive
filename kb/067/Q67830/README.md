...
{% raw %}
	...
	You can use the CH Products Mach III joystick with Flight Simulator (FS) and
	...
	Both the Mach II and the Mach III joystick provide two axis cursor controls and
