...
## Q118753: Remote Administration of DLC Network Printer is Not Available
	...
	If you attempt to remotely administer a Data Link Control (DLC) network printer,
	when you select the Settings button in the Printer Properties dialog box,
	nothing happens. Printers connected directly to a Windows NT computer can be
	remotely administered.
	
	CAUSE
	=====
	
	DLC network printing cannot be administered remotely.
	...
	Additional query words: prodnt port monitor HP
