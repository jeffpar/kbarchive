...
{% raw %}
	...
	Below is a summary of the changes to miscellaneous drivers in the Microsoft
	...
	Wacom ArtZ/ArtPad Tablets 1.0 (ARTZ-PAD.EXE) S15071
	---------------------------------------------------
	
	11/29/94 - ARTZ-PAD.EXE has been added to the WNTDL. This driver supports the
	Wacom ArtZ and ArtPad digitizing tablets.
