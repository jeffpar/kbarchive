...
## Q103944: PC Win: GP Fault Copying Many Messages to Shared Folder
	...
	When you copy a large number of messages (about 800, possibly less) to a shared
	folder, versions 3.0, 3.0b, and 3.2 of Microsoft Mail for Windows cause a
	general protection (GP) fault in the MSSFS.DLL file.
