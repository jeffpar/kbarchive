...
{% raw %}
	...
	When you have Services for Macintosh installed, the time and date stamps change
	when you change the comment of a folder, lock a file, or change the File
	Attributes of a file that is viewable to Macintosh clients.
	...
	NT Advanced Server version 3.1. For information on obtaining the Service Pack,
