...
## Q110882: GP Fault in WINLOGON.EXE
	...
	You log on with a newly created account and choose to have your Windows settings
	migrated to Windows NT. When you later log in again, WINLOGON.EXE generates a
