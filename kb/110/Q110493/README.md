...
## Q110493: Schubert: README.TXT Content
	...
	The following is the Schubert README.TXT file contained in the X:\SCHUBERT
	directory of the Multimedia Schubert CD (where X is the CD-ROM drive letter).
	
	================================================================
	MULTIMEDIA SCHUBERT VERSION 1.0 README FILE
	Microsoft Corporation
	December 7, 1993
	=================================================================
	
	This file contains information about Multimedia Schubert not
	...
	Schubert uses your computer's system memory to display
	pictures.  If you find that Schubert runs slowly or if
	you encounter out-of-memory errors, Schubert probably
	...
	* Determine how much memory your computer has available by
	  ...
	  Schubert.  If you do not have at least 4MB of
	  memory, you may not be able to run Schubert until
	  you add more memory.
	...
	* Defragment ("clean up") your hard disk by running a
	...
	NOTE - Do not remove the Schubert compact disc from
	your CD-ROM drive while Schubert is in the process of
	playing music or displaying a new picture.
	
	In order to run properly, Schubert requires an
	...
	the performance of Schubert.
	
	If the Schubert program cannot find the data files
	that it needs from the Schubert compact disc, you'll
	see a message that tells you that the correct CD must be
	in the drive to continue.  To find the source of the problem,
	do the following:
	
	* Make sure the Schubert compact disc is correctly
	...
	* If you have an external CD-ROM drive, make sure the
	...
	Schubert will run in 16-color or 256-color screen
	...
	Windows Setup to change the screen driver to see Schubert
	at its highest image quality.
	
	Some screen drivers which are capable of 256 colors appear to
	the Schubert program as if they are in 256 color mode even when
	...
	ATI PROBLEMS
	------------
	Multimedia Schubert is incompatible with some advanced features
	used by some video cards such as the Mach32 chip set running the
	ATI drivers.
	
	For Schubert to run on the ATI driver the "256 color palette"
	control in the "Advanced features" of the "ATI Control Panel"
	needs to be set to ON.  See your video card documentation for
	more information.
	
	--------------------
	HAND CURSOR PROBLEMS
	--------------------
	Whenever the mouse arrow is placed on top of clickable text (i.e.,
	...
	All of the music in Multimedia Schubert plays directly
	...
	Please note that Schubert requires an MPC-compatible
	...
	SOUND CARD PROBLEM
	------------------
	A driver which comes with the new Pro Audio Vision Sound card,
	version 1.46f, causes problems in Multimedia Schubert.  This
	driver does not keep track of the time elapsed when it is playing
	CD Audio, which causes the pages not to turn correctly in the Close
	Reading and Die Forelle chapters.  Version 1.46 of this driver does
	not have this problem, so switching to this driver will allow Schubert
	to work properly.
	
	=================================================================
	5. MEDIAVISION CDPC PROBLEMS
	=================================================================
	If you are running Multimedia Schubert using Mediavision CDPC hardware, you
	may encounter errors when you successfully make a match in 'The Trout
	Game'.
	Because these errors specifically involve the CDPC hardware, you should
	check to make sure the hardware is correctly installed.  However, it is
	still
	possible that you will encounter errors when matches are made.  Please note
	that this is only a problem in 'The Trout Game' and will not affect any of
	the
	other chapters in Multimedia Schubert.
	
	Additional query words: kbhowto 1.00multi media multimedia multi-media
