...
## Q110079: System Stops Responding When Copying Corrupt SFM Files
	...
	When you attempt to copy specific corrupt Services For Macintosh (SFM) files,
	the copy operation may stop (hang). This blocks access to the disk and
	eventually completely hangs the system.
