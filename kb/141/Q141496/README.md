...
## Q141496: DHCP Client Comment Disappears When Obtaining IP Address
	...
	If a DHCP client (for which a reservation [static entry] has been made in DHCP
	Manager) obtains its IP address, the Client Comment for this DHCP reserved entry
	disappears in DHCP Manager.
