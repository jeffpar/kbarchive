...
{% raw %}
	...
	If your computer has more than 4.2 gigabytes (GB) of commit limit memory,
	Performance Monitor does not display the amount correctly. Instead, the
	displayed value "rolls over." For example, if your computer has 4.5 GB of commit
	limit memory, Performance Monitor displays 300 MB of commit limit memory.
	
	CAUSE
	=====
	
	A DWORD (32-bit) storage value is used to store this value. A 64-bit value is
	used after you apply the hotfix.
	...
	later:
	  ...
	  ---------------------------------------------------
	  09/25/2000  05:07p  247,056  Advapi32.dll  Intel
	  09/26/2000  03:44p  192,784  Winlogon.exe  Intel
	...
	Additional query words: commitlimit
