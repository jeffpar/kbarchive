...
## Q267313: MapPoint 2001: Minimum System Requirements
	...
	to run Microsoft MapPoint 2001.
	
	MORE INFORMATION
	================
	
	To run Microsoft MapPoint 2001, you need:
	...
	- 190-245 MB of available hard disk space (your hard disk usage will vary
	  depending on configuration; 240 MB required if Microsoft Internet Explorer
	...
	Additional query words: mp2001 map point auto-map amap sysreqs requires
