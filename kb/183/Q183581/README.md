...
## Q183581: Out of Virtual Memory Messages During Windows NT Installation
	...
	During the graphical portion of an installation of Windows NT, you may receive
	...
	This error can be caused by an uninitialized parameter passed to one of the
	Windows NT setup functions.
