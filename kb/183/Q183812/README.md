...
{% raw %}
	...
	When a client application connected to a remote host over an ISDN bridge closes
	the connection, one or more of the following may occur:
	
	- If keep-alives are enabled, the ISDN connection is not permitted to timeout.
	
	- NETSTAT shows CloseSocket() as established. You must restart the computer to
