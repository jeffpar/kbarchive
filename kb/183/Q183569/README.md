...
## Q183569: AS/400 RDB Name Cannot Exceed Eight Characters
	...
	The RDB Name property of an AS/400 data source allows only eight characters to
	be entered in the edit box. However, these names can be up to 16 characters
	long.
