...
{% raw %}
	...
	The OpenSchema method does not return any information for
	DBSCHEMA_PROVIDER_TYPES. The ADO OpenSchema method does not result in any
	errors, but it does not provide any information either.
