...
{% raw %}
	...
	Client authentication with personal certificates may fail if the server is
	configured to optionally allow the use of these certificates. If this is the
	case, all connection attempts where the client does not have a personal
	certificate installed will fail.
