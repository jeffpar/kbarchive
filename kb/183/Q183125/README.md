...
{% raw %}
	...
	When you use the document Properties viewer to define a custom property to
	include a date type in a file, the year may not be saved correctly. For example,
	if you select a Microsoft Project data file (*.mpp) in a folder window, chose
	Properties on the Explorer window File menu, click the Custom tab click Date in
	the Type field, enter a value of 01/01/01, and then click Add, the date appears
	as 01/01/1901 rather than 01/01/2001.
	...
	Additional query words: y2k year 2000 word excel powerpoint project access 98 4.00
