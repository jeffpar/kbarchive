...
## Q157905: INSIDE OLE 2ND EDITION Corrections and Comments
	...
	relating to the Microsoft Press book "Inside OLE, Second Edition."
	
	The following topics are covered:
	
	- CD-ROM: Visual C++ 4.x Update Files
	...
	"Inside OLE Second Edition," by Kraig Brockschmidt, was designed and tested for
	use with Microsoft Visual C++ 2.0. Microsoft Visual C++ 4.0 will not compile
	these samples unless specific changes are made.
	
	The author, Kraig Brockschmidt, has prepared a set of updated makefiles to allow
	most Inside OLE examples to compile using Visual C++ 4.x. The files are
	contained in the INOLE2_4.EXE file.
	...
	Microsoft Press does not guarantee that this update will work, nor does
	...
	Additional query words: mspress ms_press press bookbug kbfile devbook
