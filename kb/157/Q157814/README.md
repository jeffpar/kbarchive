...
## Q157814: SMS: Remote Control Causes Windows Client to Restart
	...
	On IBM PS/2 computers equipped with Madge and IBM Token Ring cards running
	Windows 3.11 in a NetWare environment, the client will restart as soon as an SMS
	Remote Control session is initiated. This problem occurs with various client
	software configurations and ODI/VLM version levels.
