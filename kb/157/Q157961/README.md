...
{% raw %}
	...
	When Out of Office is enabled, only one reply is sent to each sender, even if
	you receive multiple messages from that person.
	
	MORE INFORMATION
	================
	
	The Out of Office Assistant sends an automatic reply to notify users who send
