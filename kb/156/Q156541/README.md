...
{% raw %}
	...
	When you upgrade Systems Management Server (SMS) 1.1 clients to SMS 1.2, the
	...
	======================================================================
	Keywords          : kbsetup kbPGC smssetup smsgeneral smsappman smspgc kbArtTypeINF kbSMSAppMan 
