...
{% raw %}
	...
	When you use the multiple Undo button, you will be able to undo a greater number
	...
	The Undo tool is new in PowerPoint for Windows 95, version 7.0. To set the
