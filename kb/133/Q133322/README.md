...
## Q133322: List of Confirmed Bugs in Windows NT Version 3.51
	...
	The following table lists confirmed problems in Windows NT version 3.51. This is
	not a comprehensive list and is current as of 21-Sep-1995. For more information
	...
	3.51, query on KBBUG3.51 in the Microsoft Knowledge Base.
	
	MORE INFORMATION
	================
	
	Summary List for Windows NT Version 3.51
	----------------------------------------
	  ...
	  Q130542: PCMCIA Modem Fails When Set to Windows NT 3.51 Default
	  ...
	  Q134762: STOP Msg: 0x0000007B Upgrading Proliant w/ Integrated SCSI-2
	  ...
	  Q134854: Windows NT LPR Does Not Support Job Removal
	  ...
	  Q135667: STOP 1E When Using File Manager and Services for Macintosh
	  ...
	  Q136896: Stop 0A in Windows NT 3.51
