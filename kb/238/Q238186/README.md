...
## Q238186: Simultaneous Terminal Server Client Logons May Not Connect
	...
	When multiple Terminal Server clients try to connect to a server, you may
	receive notification of unsuccessful logons, and an Event ID 22 may also be
	logged.
	...
	attributes or later:
	  ...
	  -------------------------------------------------------------
	  07/22/99  04:53p               134,928 Termsrv.exe   x86
	  07/22/99  04:58p               242,448 Termsrv.exe   Alpha
