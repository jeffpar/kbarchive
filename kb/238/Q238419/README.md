...
## Q238419: XADM: Information Store Stops Responding When Delivering an NDR
	...
	In certain circumstances, the information store may stop responding when
	receiving a non-delivery report (NDR) from a foreign SMTP system.
	
	CAUSE
	=====
	
	The NDR that is received by Exchange Server has information in the
	PR_SUPPLEMENTARY_INFORMATION MAPI property that is too long.
	...
	Additional query words: crash AV GPF
