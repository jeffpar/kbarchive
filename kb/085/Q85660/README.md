...
{% raw %}
	...
	This article describes how to save text in the Terminal window and how to set
	the screen buffer.
	
	MORE INFORMATION
	================
	
	Choosing Save from the Terminal File menu will not save the text on the screen.
