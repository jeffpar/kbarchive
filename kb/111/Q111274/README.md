...
{% raw %}
	...
	developed or are developing NFS connectivity software for Windows NT.
	...
	The NetManage software, Chameleon32NFS, provides client-server
	functionality for NFS which is built upon the native Windows NT TCP/IP
	protocol stack using the Windows Sockets API. The NFS functionality is
	designed to allow Windows NT connectivity with UNIX and VMS platforms.
