...
## Q111325: Can't Choose Paper Tray with Postscript Printer Driver
	...
	If a printer has two paper trays, both containing paper of the same size, you
	cannot specify which tray is used with the Windows NT Postscript printer driver.
