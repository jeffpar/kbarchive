...
## Q306854: OpenGL Program May Generate Access Violation Error Message
	...
	An OpenGL program that makes thousands of calls to glVertex while trying to draw
	a polygon, may not work, and you may receive an access violation error message.
	
	CAUSE
	=====
	
	This problem can occur because a logic error can cause the code to proceed past
	the end of an array.
	...
	attributes or later:
	  ...
	  ---------------------------------------------------------------
	  09/21/01  15:01  4.0.1381.7097  699,664  Opengl32.dll  Intel
	...
	To work around this problem, add a glFlush call after every glEnd call.
