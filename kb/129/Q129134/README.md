...
## Q129134: XCLN: Cursor Position May Be Incorrect When Deleting Text
	...
	In long lines of text, the cursor may be incorrectly positioned at the end of a
	line when you delete text. The expected behavior is that the cursor should be
	located at the beginning of the line below.
