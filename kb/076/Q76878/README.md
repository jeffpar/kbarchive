...
{% raw %}
	...
	The Setup program for Windows with Multimedia Extensions detects a installed
	...
	If Setup detects a current Windows directory, it will display the directory
