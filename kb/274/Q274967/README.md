...
{% raw %}
	...
	The first player that exits a multiplayer team game of Microsoft Combat Flight
	Simulator 2 receives credit for all of the kills and deaths that were recorded
	by that player's team.
