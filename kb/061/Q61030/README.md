...
## Q61030: WD97: Setting Custom Superscipt/Subscript Font Size and Position
	...
	Operating System(s): 
	Keyword(s): kbui kbdta winword word97
	...
	The superscript and subscript formats that are applied to text using the
	predefined key combinations automatically raise or reduce the font size of the
	selected text. To create easy-to-apply custom superscript and subscript formats,
	...
	Because the predefined key combinations cannot be assigned to a specific point
	position, use the following process to assign key combinations to different
	character positions:
	...
	5. Change the number in the Raised (or Lowered) list to the scripting height you
	  want (for example, 5 pt).
	
	6. Click in the "Press new shortcut key" text box, and press a key combination
