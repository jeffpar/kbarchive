...
## Q126715: INVDOS Does Not Detect NEC 3x CDROM drives
	...
	INVDOS does not detect a NEC 3X CD-ROM drive installed on an MS-DOS or Windows
	workstation, even though Microsoft Diagnostics (MSD) does detect the drive and
	the version of MSCDEX that is installed.
	...
	Additional query words: sms prodsms cdrom
