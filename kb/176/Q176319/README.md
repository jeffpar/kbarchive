...
{% raw %}
	...
	If the OLE function IStorage::SetElementTimes is performed on a storage object
	obtained by standard marshalling, with one or more parameters set to NULL, the
