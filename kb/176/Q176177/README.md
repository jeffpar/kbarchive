...
## Q176177: XADM: Outlook Client Connects to Remote Public Folder Servers
	...
	When you click the plus sign on the left panel in an Outlook client for public
	folders, the client connects to the content server instead of the hierarchy
	server.
