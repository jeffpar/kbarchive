...
## Q176087: LPRMON Status Strings Are No Longer Localized on German Version
	...
	LPR displays its status messages in English on the German version of Windows NT
	4.0 after installing Service Pack 3.
	
	CAUSE
	=====
	
	These strings were moved out of the resources and could not be localized.
