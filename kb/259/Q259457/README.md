...
## Q259457: Allegiance Error Message: Failed to Connect to the Lobby
	...
	When you click Free Games and then click Games List, you may receive the
	...
	- The Allegiance browser server for public games is unavailable.
	
	RESOLUTION
	==========
	
	To resolve this issue, use the following methods in the order in which they are
	presented. If the issue continues to occur, proceed to the next method or try
	connecting to Free Games at a later time.
