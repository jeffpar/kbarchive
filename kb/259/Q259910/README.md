...
{% raw %}
	...
	You can control the access to TN3270 resources (LUs and/or Pools) when you
	...
	The TN3270 server, included with SNA Server, supports the following two types of
	session requests:
