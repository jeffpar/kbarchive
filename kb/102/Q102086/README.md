...
## Q102086: PC Win: Print Quality Always Set to High
	...
	When you print from version 3.0, 3.0b, or 3.2 of Microsoft Mail for Windows,
	print Quality always defaults to high, even when the printer driver is set for
	draft.
