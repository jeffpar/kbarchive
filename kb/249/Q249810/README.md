...
{% raw %}
	...
	When you create a rule to automatically forward messages to another user, and a
	message that is in plain text format is forwarded by this rule, the message is
	...
	version 5.5 SP3 . This problem was first corrected in Exchange Server 5.5
	Service Pack 4.
