...
{% raw %}
	...
	Operating System(s): 
	Keyword(s): kbsms200 kbsms200bug kbDiscovery kbsms200sp2fix kbgraphxlinkcritical
	...
	must apply the fix described in this article to all SMS 2.0 sites with Service
	Pack 1 (build 1380) before any site is upgraded to SMS 2.0 SP2. Click the
	following file name to download the file from the Microsoft Download Center:
	
	  DownloadDownload Q249077.exe now
	...
	1. Copy the update folder structure to a share on your network. Q249077.exe is a
	...
	4. Run Q249077.exe and follow the directions in the wizard. You can run the file
