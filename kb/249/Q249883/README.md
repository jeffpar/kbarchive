...
## Q249883: XFOR: Migration Wizard Reports Error Message 12024
	...
	When you run the Exchange Server Migration Wizard to migrate Lotus Notes users,
	you may receive the following error message:
	
	  Event ID: 12024
	  Source: MSExchangeMig
	  Type: Error
	  Description: While migrating Lotus Notes user '%1', '%2' messages were skipped
	  because of errors encountered during their conversion.
