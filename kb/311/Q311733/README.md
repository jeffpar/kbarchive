...
{% raw %}
	...
	If you place a DBCombo control on a modal form, the DBCombo control may not
	respond to mouse actions. This problem was previously documented for Visual
	Basic 4.0. For additional information, click the article number below to view
	...
	later:
	  ...
	  ------------------------------------------------------
	  18-Oct-2001  22:45   6.0.93.85   208,384  DBList32.ocx
