...
{% raw %}
	...
	This article provides instructions to manually install Microsoft 500 Nations for
	Windows.
	...
	1. Copy the following files from the D:\Nations\_Setup\Vfw16 folder to the
	  C:\Windows folder:
	  ...
	  "copy d:\nations\_setup\vfw16\mplayer.exe c:\windows" (without the quotation
	  marks)
	
	2. Copy all of the files in the D:\Nations\_Setup\Wing folder to the
	...
	3. Copy all of the files in the D:\Nations\_Setup\Ole2 folder to the
	  C:\Windows\System folder. The files are:
	...
	4. Copy the following files from the D:\Nations\_Setup\Vfw16 folder to the
	...
	5. Copy all of the files in the D:\Nations\_Setup\System folder to the
	  C:\Windows\System folder. The files are:
	...
	6. Use a text editor, such as Microsoft Notepad, to make the following changes
	  to the Nations.ini file, which is located in the Windows folder. If the
	  Nations.ini file does not already exist, create one in the Windows folder
	  with these entries:
	...
	8. On the File menu in Program Manager, click Run. Type the following command,
	  ...
	  "d:\nations\_setup\vfw16\mplayer.reg" (without the quotation marks)
	
	  Repeat this step using the following command lines:
	
	  "d:\nations\_setup\ole2\ole2.reg
	  d:\nations\_setup\vfw16\cleanup.reg" (without the quotation marks)
	
	9. Add the 500 Nations icons to Program Manager by following the instructions at
	...
	1. Copy the following files from the D:\Nations\_Setup\Vfw32 folder to the
	...
	2. Copy all the files in the D:\Nations\_Setup\Wing folder to the
	...
	3. If you are running Windows NT, copy the following file from the
	  D:\Nations\_Setup\Vfw32 folder to the C:\Windows\System32 folder:
	...
	4. Use a text editor, such as Microsoft WordPad, to make the following changes
	  to the Windows information files. These files are located in the Windows
	  folder.
	...
	If you are using Windows 95, add 500 Nations to the Start Menu by following these
	instructions:
	...
	4. Type the following in the Command Line box, and then click Next:
	  ...
	  "d:\nations.exe" (without the quotation marks)
	...
	If you are using Windows Program Manager, create the 500 Nations icons using the
	...
	5. Repeat steps 2 through 4 for each item listed below:
	     ...
	     Description:       500 Nations Readme
	     Command Line:      d:\readme.txt
	
	     Description:       Microsoft Multimedia Catalog
	     Command Line:      d:\mmcat\catppi.exe
	
	Additional query words: kbhowto 1.00 multi media multimedia multi-media mmtitles install create subdirectory directory manually installation
