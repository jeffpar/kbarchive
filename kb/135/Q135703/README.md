...
{% raw %}
	...
	When you save an attachment from the Windows client, you can not change the
	...
	The default directory where attachments are saved is the directory containing
	the MSMAIL.EXE file.
