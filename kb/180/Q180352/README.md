...
## Q180352: XWEB: No &quot;Send Again&quot; Option on NDR Using ASC or OWA
	...
	When you are using the Outlook Web Access (OWA) client to access a Microsoft
	Exchange Server mailbox and you receive a non-delivery report (NDR), there is no
	...
	At this time, the "Send Again" option is only available in the Exchange and
	Outlook clients.
