...
## Q180060: XCLN: Autoforwarded E-form Does Not Prefix Subject Line With FW:
	...
	When you AutoForward an Electronic Form using an Inbox Assistant rule, the
	subject line does not begin with "FW:".
	
	WORKAROUND
	==========
	
	To work around this problem, use Outlook Forms Designer. When you AutoForward
	forms using Outlook Forms Designer, the subject line is prefixed with "FW:".
