...
{% raw %}
	...
	When you use Novell Client 32 on a computer running Windows 95, duplicate and
	erroneous file information will be displayed when performing a directory listing
	on an FPNW drive mapping.
	...
	Additional query words: double shadow ipx
	======================================================================
