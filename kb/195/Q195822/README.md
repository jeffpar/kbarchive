...
## Q195822: Server Responds to PAP Client on Different AppleTalk Node
	...
	respond to client connection requests on a different AppleTalk address to that
	on which the original request was received.
	
	This behavior may cause issues for client applications that do not tolerate a
	change of network and node number during PAP connection establishment.
	...
	Additional query words: 4.00 delta macprint atp ddp pap node heidelberg
	======================================================================
