...
{% raw %}
	...
	Operating System(s): 
	Keyword(s): kb3rdparty kbdisplay kberrmsg kbimu msgame golf98
	...
	When you attempt to start Golf 1998 Edition, you may receive the following error
	message:
	
	  Error loading texture file Shad.bmp.
	
	CAUSE
	=====
	
	This behavior can occur if an outdated video driver for your display adapter is
	...
	Additional query words: 1.00 msgame golf98 card
	
	======================================================================
	Keywords          : kb3rdparty kbdisplay kberrmsg kbimu msgame golf98 
