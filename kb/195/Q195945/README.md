...
## Q195945: Traced version of the x.25 link service doesn't provide output
	...
	The traced version of the SNA Server x.25 link service (trcx25.dll) does not
	generate any trace output when enabling traces using the SNA Server trace
	program (snatrace.exe).
	...
	This file does NOT ship with the SNA Server product. It is usually sent to
	customers when it is needed for troubleshooting purposes.
