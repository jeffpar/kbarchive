...
{% raw %}
	...
	After you install an intermediate network driver, such as the DynamicAccess
	software Intermediate driver from 3COM Corporation, the Windows NT computer may
	display a blue screen error message in Tcpip.sys with a STOP 0x0000001E. The
	second dword of the stop code will be 0xC00000005. This has only been observed
	on multiprocessor computers. An intermediate driver is a network driver that is
	layered between a transport driver and a miniport driver to provide added
	functionality.
