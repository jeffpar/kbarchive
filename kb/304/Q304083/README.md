...
## Q304083: XADM: Can't Use CDO to Remove Attendees from Recurring Meeting
	...
	If you use Collaboration Data Objects (CDO) to try to remove a user from an
	instance of a recurring appointment item, and then try to send an update to that
	user alone by changing the status to "CdoMeetingCanceled," all of the users may
	be notified. The code works correctly on a non-recurring appointment item.
