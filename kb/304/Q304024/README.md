...
## Q304024: XADM: Information Store Stops with Malformed Content-Type
	...
	When the information store attempts to convert a Multipurpose Internet Mail
	Extensions (MIME) message with an invalid format, the Exchange Server
	Information Store service may stop unexpectedly or may generate a Dr. Watson
	access violation.
	
	CAUSE
	=====
	
	This problem can occur if the Content-Type field of a MIME message that is being
	converted contains invalid characters.
