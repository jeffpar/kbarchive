...
## Q130735: Quick Windows Viewer Displays Blue Backgrounds For Text/Icons
	...
	Version(s): winnt:1.1
	Operating System(s): 
	Keyword(s): kbtshoot kbui smsremtshoot kbRemoteProg
	...
	Text and icons appear with a dark blue background in Quick Windows Viewer during
	a Windows for Workgroups 3.11 remote control session.
	...
	======================================================================
	Keywords          : kbtshoot kbui smsremtshoot kbRemoteProg 
