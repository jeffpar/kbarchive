...
{% raw %}
	...
	Odd behavior occurs when you run a PowerPoint slide show with the products
	listed below:
	...
	The palette shift results from interaction between PowerPoint's graphics display
