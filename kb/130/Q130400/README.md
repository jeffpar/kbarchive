...
{% raw %}
	...
	When you use multiple protocols under Windows NT, the first protocol
	installed becomes the default protocol. To change your default protocol:
	...
	You are given the option to restart the system. You do not have to restart
	the system at this time but the changes you made will not take effect until
