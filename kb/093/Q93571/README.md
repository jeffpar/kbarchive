---
layout: page
title: "Q93571: PC DirSync: CTRL+C Displayed But Not Used in REQMAIN.EXE"
permalink: kb/093/Q93571/
---
...
## Q93571: PC DirSync: CTRL+C Displayed But Not Used in REQMAIN.EXE
	...
	When you run REQMAIN.EXE and press CTRL+C while it is processing, REQMAIN
	continues to process even though the CTRL+C keystrokes display on the screen.
	Data displayed by REQMAIN scrolls up one line for each CTRL+C.
	
	CAUSE
	=====
	
	MS-DOS traps the CTRL+C keystroke sequence while REQMAIN continues to call
	MS-DOS functions.
