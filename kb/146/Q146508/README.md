...
{% raw %}
	...
	When you have text that is selected, and have enabled the bullet button, and
	then select the underline button, the entire selection is not underlined. The
	only areas that are underlined are the text itself and under the bullet itself.
	The area between the bullet and the text lacks the underline.
