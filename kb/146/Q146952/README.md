...
{% raw %}
	...
	When you embed a saved message into a new message, the title of the embedded
	...
	Microsoft Exchange assigns the subject text as the file name when a message is
