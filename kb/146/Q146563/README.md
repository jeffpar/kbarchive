...
{% raw %}
	...
	If you submit a message to an invalid recipient and receive a Non-Delivery
	Report (NDR), you may resend this message and correct the recipients address.
	However, the message received by the recipient will still list the invalid
	address.
	...
	Additional query words: headers recipient wrong address
