...
## Q146095: STOP: 0x0000000A or STOP: 0x0000001E in Tcpip.sys
	...
	Version(s): WinNT:4.0
	Operating System(s): 
	Keyword(s): kberrmsg kbinterop kbnetwork kbWinNT400sp4fix
	...
	Your computer running Microsoft Windows NT Server version 4.0 running Microsoft
	Proxy Server version 2.0 may display one of the following blue screens error
	messages:
	...
	-or-
	  ...
	  STOP 0x0000001e Unhandled Kernel exception
	...
	======================================================================
	Keywords          : kberrmsg kbinterop kbnetwork kbWinNT400sp4fix 
