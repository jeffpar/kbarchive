...
{% raw %}
	...
	A Microsoft Schedule+ meeting request is sent to User2 from User1. User2
	forwards this to User3 using Cc: on the meeting response message. User3 can then
	read the message and change the text in the message body.
