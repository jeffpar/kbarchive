...
## Q146988: XCLN: Escape Doesn't Close Mailbox Properties from General Tab
	...
	When you display the properties of the mailbox or a set of folders, you can tab
	to the description field to type in a description on the General tab. However,
	if you hit the Escape key (ESC) while the description field is active, the
