...
## Q146082: XCLN: Adding Subfolder to Outbox Changes Icon
	...
	When you create a subfolder in the Outbox folder, the Outbox icon changes to
	have the appearance that there are outgoing messages waiting to be sent (that
	is, it turns red).
