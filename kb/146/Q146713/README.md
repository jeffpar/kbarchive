...
{% raw %}
	...
	In Microsoft Exchange Windows clients, the following error will occur when a
	message with an attachment is saved and the options to sign and seal the message
	are selected:
	
	  The advanced security operation failed. A resource is busy or you lack
	  sufficient access rights or permissions.
	...
	Additional query words: Enhanced Security MSG
