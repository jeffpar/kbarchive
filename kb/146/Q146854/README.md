...
{% raw %}
	...
	When you view a message's properties, you will get a Save Changes prompt even
	though you did not make any changes to either the message or the properties of
	the message.
