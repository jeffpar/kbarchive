...
{% raw %}
	...
	- On the Tools menu, on the Options dialog box, on the Edit tab, the Use smart
	  cut and paste check box is selected.
	
	  -and-
	
	- On the Tools menu, on Track Changes, in the Highlight Changes dialog box, the
	  Track changes while editing check box is selected.
	...
	Additional query words: deleted, removed, revision, insertion
