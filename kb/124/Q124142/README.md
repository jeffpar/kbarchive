...
{% raw %}
	...
	When you run Registry Editor and select a key with the mouse and press ENTER at
	the same time, the computer stops responding (hangs) or you receive and Out of
	...
	Additional query words: prodnt winfile.exe regedit.exe
