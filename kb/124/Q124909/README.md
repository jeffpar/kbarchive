...
## Q124909: Problems Accessing Drive Formatted with Ontrack Disk Manager
	...
	When you attempt to install Windows NT on a system with a drive that has been
	formatted by Ontrack System's Disk Manager, you cannot access the drive, either
	during Setup or after Setup has completed.
	
	CAUSE
	=====
	
	Windows NT version 3.5 does not recognize drives that have been formatted using
