...
## Q124940: STOP 0x0000000A when Accessing NetWare Server
	...
	A STOP message (0x0000000A) may occur when attempting to access a NetWare share
	from File Manager with Client Services for NetWare (CSNW) installed. Below is a
	listing of the debug session:
