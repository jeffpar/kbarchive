...
## Q124796: DHCP Client Does Not Support Domain Name Option
	...
	The Windows NT version 3.5 dynamic host configuration protocol (DHCP) client
	does not recognize the domain name sent by the Windows NT DHCP Server.
	...
	Additional query words: prodnt option 15 dhcp
