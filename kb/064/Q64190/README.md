...
{% raw %}
	...
	Microsoft Windows allows you to run Windows applications that have 256- color
	...
	Each Windows application is written to support a maximum number of colors. For
