...
{% raw %}
	...
	When you run a 16-bit Windows NETDDE application, the following error message
	may appear on the Windows NT console:
	
	  System Error
	  The WIN 16 SubSystem was unable to allocate memory for this DDE Transaction.
	  Shutting down the conversation.
	
	CAUSE
	=====
	
	This is a problem in the WIN 16 subsystem.
