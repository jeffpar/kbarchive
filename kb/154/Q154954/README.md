...
{% raw %}
	...
	There are only two sort options provided by the Microsoft Exchange Administrator
	...
	To change the sort option for the Recipients container, select Sort from the
