...
{% raw %}
	...
	Microsoft plans to include this technology, which is currently available in
	Windows 95, in a future release of Windows NT.
	
	MORE INFORMATION
	================
	
	Most new portable computers support advanced power management (APM). Windows 95
