...
{% raw %}
	...
	If you remotely control a Windows 95 computer and run the Microsoft Word Setup
	program, the text in the banners is corrupted in the SMS Quick Windows Viewer.
	...
	Additional query words: winword helpdesk corrupted truetype wuser smsadmin win95 prodsms sms
