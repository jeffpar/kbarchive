...
{% raw %}
	...
	When the FilterKeys feature is enabled, this warning message is always
	displayed.
	
	If you have the SlowKeys feature enabled, keyboard input acceptance is delayed
	and it may appear that keystrokes are not being accepted.
	...
	- Disable FilterKeys with the emergency hot key:
	  ...
	  5. To toggle the FilterKeys option off, press down and hold the right SHIFT
	     for approximately eight seconds.
	
	Additional query words:
	
	======================================================================
	Keywords          : kbenable win95 kbEnableMove 
