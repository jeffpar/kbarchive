...
{% raw %}
	...
	When you administer an Internet Information Server (IIS) 4.0 Web site from a
	UNIX browser with a version number that is less than 4.0, the Backup and Delete
	buttons may not appear.
