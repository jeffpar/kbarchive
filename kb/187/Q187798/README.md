...
## Q187798: XWEB: Appointment Shows End Date In Different Month Than Start
	...
	When you create an appointment in the Outlook Web Access client, if the Start
	Date begins in February and you modify any part of the End Date, the End Date
	month will change from February to March. This only occurs for dates beginning
	in February.
